...
![set as featured icon](media/service-dashboard-featured/power-bi-feature-nav.png)
...
2. In the top navbar, you'll either see **Set as featured** or just the featured  ![featured icon](media/service-dashboard-featured/power-bi-featured-icon.png)  icon. Select either one.
   
    ![Set as featured icon](media/service-dashboard-featured/power-bi-set-as-featured.png)
3. Confirm your selection.
   
    ![set featured dashboard](media/service-dashboard-featured/power-bi-create-featured.png)
...
1. Follow steps 1 and 2 from above.
    ...
    ![Change featured dashboard window](media/service-dashboard-featured/power-bi-change-feature.png)
2. Select **Set as featured**. Un-featuring a dashboard does not remove it from your workspace.  
   
    ![success message](media/service-dashboard-featured/power-bi-success.png)
...
2. In the top menubar, select **Disable featured**.
    ...
    ![delete featured](media/service-dashboard-featured/power-bi-unfeature.png)
