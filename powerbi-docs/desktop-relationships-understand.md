...
> [!IMPORTANT]
> It is important to understand that model relationships do not enforce data integrity. Refer to the [Relationship evaluation](#relationship-evaluation) topic later in this article to learn how model relationships can respond to data integrity issues in your data.
...
- The **RELATED** DAX function cannot be used to retrieve the "one" side column values
