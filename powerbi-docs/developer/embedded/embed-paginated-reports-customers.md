...
>* Premium Per User (PPU) is not supported. You can use a PPU license to experiment with the solution, but you'll not be able to [move to production](embed-sample-for-customers.md#move-to-production).
