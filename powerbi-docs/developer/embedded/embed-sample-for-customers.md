...
|Permissions |[Permissions](/azure/active-directory/develop/v2-permissions-and-consent) (also known as scopes) to access the Power BI REST APIs, are granted by your Azure AD app. |Permissions to access the Power BI REST APIs are determined by the *master user* account. |
