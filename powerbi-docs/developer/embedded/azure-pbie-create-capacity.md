...
|Embedded Gen1  |Embedded Gen2  |
|---------|---------|
|Use this template to create a classic Power BI Embedded resource.     |Use this template to create an [Embedded Gen 2](power-bi-embedded-gen2.md) resource.         |
|```json
{
