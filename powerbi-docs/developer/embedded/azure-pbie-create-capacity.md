...
:::code language="json" source="https://github.com/Azure/azure-quickstart-templates/blob/master/101-power-bi-embedded/azuredeploy.json" range="1-57" highlight="1-57":::
