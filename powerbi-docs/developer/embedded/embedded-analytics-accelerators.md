...
| :::image type="content" source="./media/embedded-analytics-accelerators/carlo-solutions-logo.png" alt-text="Picture of the Carlo Solutions logo."::: | **Carlo Solutions**' accelerator: <br> **Entelexos** is a software designed to accelerate your business' need for sharing data. Suitable for Startups, Small Business, all the way up to Enterprise solutions. <br> [Watch an overview interview video of Entelexos](). | :::image type="content" source="./media/embedded-analytics-accelerators/entelexos-logo.png" alt-text="Picture of the Entelexos logo."::: <br> [Entelexos](https://www.entelexos.com/) |
