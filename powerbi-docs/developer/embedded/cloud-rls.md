...
**APPLIES TO:** :::image type="icon" source="../../includes/media/yes-icon.svg" border="false":::&nbsp;App&nbsp;owns&nbsp;data :::image type="icon" source="media/no-icon.svg" border="false":::&nbsp;User&nbsp;owns&nbsp;data
