...
>[!TIP]
>You can also use the [Premium Gen2 Monitoring App](../../admin/service-premium-gen2-metrics-app.md)to monitor your [Embedded Gen 2](../developer/embedded/power-bi-embedded-generation-2.md) capacity.
