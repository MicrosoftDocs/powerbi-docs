...
description: Step by step guide to purchasing and setting up Power BI Embedded.
author: mberdugo
...
Once you've made the decision that you want to purchase and start using Power BI Embedded for you to share your reports with others, follow these instructions to 

## Before you begin

Before you can start downloading Power BI Embedded, you need to decide if you want to download Po
