...
| Read and write all Workspaces |The app can view and write to all the workspaces for the signed in user and any workspace that the user has access to. This does not provide rights to create a new workspace. |Group.ReadWrite.All |
| Read and write all Capacities |The app can view and write to all the capacities for the signed in user and any capacity that the user has access to. This does not provide rights to create a new capacity. |Report.ReadWrite.All |
| Read all Capacities |The app can view and write to all the reports for the signed in user and any reports that the user has access to. This does not provide rights to create a new report. |Capacity.ReadWrite.All |
