...
From API version 3.8.3 you can also create [Modern visuals tooltips](../../create-reports/desktop-visual-tooltips.md). Modern visuals tooltips add data point drill actions to your tooltips, and update the styling to match your report theme.
