...
[Modern visuals tooltips](../../create-reports/desktop-visual-tooltips.md) adds data point drill actions to your tooltips, and updates the styling to match your report theme.
