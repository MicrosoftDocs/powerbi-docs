...
* If you have a Power BI account, use the Power BI service to develop a visual [on-the-fly](./custom-visual-develop-tutorial.md) instead of repackaging them with the `pbiviz package` command.
...
To learn more, see additional tutorials on [Power BI visuals](./custom-visual-develop-tutorial.md) and [R visuals](../../visuals/service-r-visuals.md).
