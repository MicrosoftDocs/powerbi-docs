...
>
> With the latest **version 2.1**, Power BI visual load times have improved by 20% on average.
...
For more information, see [User Timing API](https://msdn.microsoft.com/library/hh772738(v=vs.85).aspx).

### Review the animation loop
...
For more information, see [youmightnotneedjquery.com](http://youmightnotneedjquery.com/) on alternative examples to JQuery functions `show`, `hide`, `addClass`, and more.  
...
If you use [requestAnimationFrame](https://www.w3.org/TR/animation-timing/) to update your on-screen animations, your animation functions are called **before** the browser performs the next repaint.

For more information, see this [sample](https://testdrive-archive.azurewebsites.net/Graphics/RequestAnimationFrame/Default.html) of smooth animation using `requestAnimationFrame`.
