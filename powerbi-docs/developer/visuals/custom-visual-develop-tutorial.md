...
> [!NOTE]
> If the certificate is not recognized, you may need to restart your computer. Some browsers such as Firefox require that you to trust the self signed certificate. To do that, navigate to the webpack server page (https://localhost:8080/webpack-dev-server), and accept the risk.
