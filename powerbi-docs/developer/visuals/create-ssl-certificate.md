...
For the Windows, macOS X, and Linux procedures, you must have the Power BI Visual Tools **pbiviz** package installed. For more information, see [Set up the developer environment](./custom-visual-develop-tutorial.md#setting-up-the-developer-environment). 
...
For more information and instructions for installing a certificate, see [Create and install a certificate for Windows](./custom-visual-develop-tutorial.md#windows).
...
For more information and instructions, see [Create and install a certificate for OS X](./custom-visual-develop-tutorial.md#osx).
