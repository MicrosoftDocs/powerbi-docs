...
- [Live connect reports](https://learn.microsoft.com/power-bi/connect-data/service-live-connect-dq-datasets#live-connection) saved as PBIP require the [XMLA Endpoint](https://learn.microsoft.com/fabric/admin/service-admin-portal-integration#allow-xmla-endpoints-and-analyze-in-excel-with-on-premises-datasets) to be enabled.
