...
> [!IMPORTANT]
> If you import your semantic model using any other import method, such as [Power BI Desktop Publish](../../create-reports/desktop-upload-desktop-files), Fabric Git Integration will switch back to the default TMSL format.
