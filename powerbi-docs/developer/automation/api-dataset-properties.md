...
dataType     |  String       |  Supported [EDM data types](https://msdn.microsoft.com/library/ee382832.aspx)  and restrictions. See [Data type restrictions](#data-type-restrictions-applies-to-dataType-property).      |  False       | True        
