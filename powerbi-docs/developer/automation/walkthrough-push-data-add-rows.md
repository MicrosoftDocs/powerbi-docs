...
1. In the Console Application project you created in Step 2: Walkthrough to push data, [Get an authentication access token](automation/walkthrough-push-data-get-token.md), add the code below.
