...
5. Fill in the required information and then select **Create**.
    ...
    |**Location**|The location where Power BI is hosted for your tenant. Your default location is your home region, but you can change the loaction using Multi-Geo options.
