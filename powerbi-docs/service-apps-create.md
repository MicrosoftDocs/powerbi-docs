---
title: Create service apps in Power BI
description: How to create service apps in Power BI that you can distribute on AppSource.
author: maggiesMSFT
manager: kfile
ms.reviewer: ''
ms.service: powerbi
...
# Create service apps in Power BI

Learn how to create service apps in Power BI that you can distribute on AppSource.
