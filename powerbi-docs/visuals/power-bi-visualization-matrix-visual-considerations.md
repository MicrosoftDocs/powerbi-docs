...
You can also use the [auto-size width options that are available in the Column Headers settings](power-bi-visualization-matrix-visual-format-setting.md#column-headers-settings).
