...
- Ability to convert to a different type of visual that designers can save in reports and pin to dashboards. This is useful for when you wish to create reports quickly and it saves you time from dragging and dropping.
- [Q&A tooling](qna-tooling-intro.md) which allows designers to configure the underlying natural language engine.
...
## Create a Q&A visual using a suggested questions
...
3. To create the visual, select one of the suggested questions or start typing in the question box. In this example, we've selected **top geo states by sum of revenue**. Power BI does its best to select which visual type to use. In this case, it's a map.
    ...
    ![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-specify-map.png)

## Create a Q&A visual using a natural language query
In the example above, we selected one of the suggested question to create our Q&A visual.  In this exercise we'll type our own question. As we type our question, Power BI helps us with auto-complete, suggestion, and feedback.
...
![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-terminology.png)
...
2. As we type more of the question, Power BI lets us know that it doesn't understand the question, and tries to help. In the example below, Power BI asks us "Did you mean..." and suggests a different way to word our question using terminology from out dataset. 

    ![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-define.png)
...
5. With Power BI's help, we were able to ask a question with all recognizable terms. Power BI displays the results as a line chart. 
    ...
    ![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-type.png)


6. Let's change the visual to a column chart. 

    ![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-specify-visual.png)
...
1. In the menu bar, select the **Home** tab and choose **Switch theme**. 
    ...
    ![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-themes.png)

    
    
2. In this example we've selected **More themes** > **Colorblind safe**.

    ![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-color-blind.png)
...
![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-q-and-a-format.png)

## Convert your Q&A visual into a standard visual
We've formatted our colorblind safe column chart visual a bit -- added a title and a border. Now we're ready to convert it to a standard visual in our report and also pin it to a dashboard.

Select the icon ![](media/power-bi-visualization-q-and-a/power-bi-convert-icon.png) to **Turn this Q&A result into a standard visual**.

![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-visual-convert.png)
...
![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-pin.png)


## Advanced features of the Q&A visual
Selecting the cog icon opens the Q&A visual Tooling pane. 

![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-q-and-a-tooling.png)
...
![Q&A visual map](media/power-bi-visualization-q-and-a/power-bi-q-and-a-tooling-pane.png)
