...
- When adding a Power BI report that contains a paginated report visual into a Power BI App, a user must have at least Viewer role access to the paginated report workspace in order to view the paginated report in the visual.
