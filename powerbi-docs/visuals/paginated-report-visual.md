...
- The paginated report visual isn't supported for subscription or export. You can open the underlying paginated report itself and create a subscription to it, as explained in [Subscribe to paginated reports](../consumer/end-user-subscribe?tabs=creator#subscribe-to-paginated-reports).
