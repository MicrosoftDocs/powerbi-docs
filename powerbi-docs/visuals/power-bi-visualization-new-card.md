...
- In earlier versions of the Card visual, the **Callout** image was available as part of the **Image card**. This has now been moved to the **Callout** section of the **Format** pane.
