...
description: Make meetings more productive in Microsoft Teams with Power BI. Add reports, share data, and drive data-driven decisions before, during, and after meetings.
author: julcsc
...
### Add a Power BI report or scorecard to a meeting

Follow these steps to add a Power BI report or scorecard to a meeting.
...
1. In the confirmation dialog, select **Save**.
    ...
    :::image type="content" source="media/business-user-teams-meetings/power-bi-teams-create-tab.png" alt-text="Screenshot of the dialog to save and add the new Power BI tab.":::
...
1. See [Give team members permission to view Power BI content](business-user-teams-share-data.md#give-team-members-permission-to-view-power-bi-content) for how to share with your colleagues.
...
When you're in a meeting, data can help guide the discussion or answer questions raised by attendees. You can easily present data in Power BI during the meeting, share links to data with meeting attendees, and find data that can answer questions.

1. After joining the meeting, go to the Teams window.
...
### Capture and share visuals in a meeting

1. View the report in the Power BI app in Teams.
1. Select a visual.
1. Select **Copy as image with caption** to copy the visual.

    :::image type="content" source="media/business-user-teams-meetings/teams-power-bi-copy-visual.png" alt-text="Screenshot of a visual with the Copy visual as image icon highlighted.":::
...
1. Select the **Share** button.
    ...
    :::image type="content" source="media/business-user-teams-meetings/power-bi-teams-chat-teams.png" alt-text="Screenshot of a Power BI report in a Teams meeting with the Share button highlighted.":::
...
1. Select the **Actions and apps** icon with the plus sign.
1. Select **Power BI**.
...
Share a summary of the most important data points discussed and the actions the team plans to take to help achieve outcomes. If you captured visuals during the meeting in chat, you can pull them into a meeting summary post in the chat or in a follow-up message.
