...
* Although org apps can contain real-time dashboards and notebooks, Power BI mobile apps support only Power BI items. Therefore, the app's overview page and content list include other Fabric items, but those items open in the browser.

* The Power BI mobile apps currently don't support audience tabs.

* The Power BI mobile apps currently don't support sharing org apps or items within org apps.