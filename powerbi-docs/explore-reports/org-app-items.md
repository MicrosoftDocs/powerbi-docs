...
- Org apps support email subscriptions for Power BI reports (preview). However, subscriptions in org apps have some differences compared to subscriptions created directly on reports. See **Subscriptions for reports in org apps (preview)**.
