...
The following diagram shows a basic view, which we'll expand on later in this article.

![Gateway overview](media/service-gateway-overview/gateway-overview.png)
