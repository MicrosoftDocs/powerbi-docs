 ...
 **Download** ![download](media/reportserver-quickstart-install-report-server/download.png "download")
...
![tip](media/reportserver-quickstart-install-report-server/fyi-tip.png "tip") For the current release notes, see [Power BI Report Server - Release notes](reportserver-release-notes.md).
