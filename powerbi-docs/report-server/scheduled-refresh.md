...
:::image type="content" source="media/scheduled-refresh/scheduled-refresh-success.png" alt-text="Screenshot of scheduled refresh within Power BI Report Server.":::
