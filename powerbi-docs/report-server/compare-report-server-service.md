...
| Personalize visuals | No | No | You can [interact with a report to see different data](../consumer/end-user-paginated-report#interact-with-a-paginated-report), but you can't modify the report itself. |
