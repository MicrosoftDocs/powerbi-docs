...
If your organization has purchased Power BI Premium capacity, you can get the key for Power BI Report Server from the **Premium Settings** tab in the [admin portal](../admin/admin-center.md#how-to-get-to-the-admin-portal). The key is accessible to only users with Global admin, Fabric admin, or Power BI Premium capacity admin privileges.
...
If your organization has purchased F64 SKU and above reserved instances, you can get the key for Power BI Report Server from the **Capacity Settings** tab in the [admin portal](../admin/admin-center.md#how-to-get-to-the-admin-portal). The key is only accessible to users with Global admin, Fabric admin, or Power BI Premium capacity admin privileges.
...
* [How to get to the admin portal](../admin/admin-center#how-to-get-to-the-admin-portal)
