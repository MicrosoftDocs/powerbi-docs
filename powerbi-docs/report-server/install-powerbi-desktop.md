...
1. At the end of the installation, select **Launch Power BI Desktop**.
...
It's easy to verify that you're using the correct Power BI Desktop: Look at the launch screen or title bar within Power BI Desktop. You can tell you have the right version because the release month and year appear in the title bar (for example, **Power BI Desktop (September 2025)**). Also, the Power BI logo colors are reversed, yellow on black instead of black on yellow.

:::image type="content" source="media/install-powerbi-desktop/power-bi-report-server-desktop.png" alt-text="Screenshot of Power BI Desktop with release date in title bar.":::
...
Power BI Report Server reports support all the basic functionality in the [Power BI mobile apps](../explore-reports/mobile/mobile-apps-for-mobile-devices.md), including:

- [Phone report layout](../create-reports/power-bi-create-mobile-optimized-report-about.md): You can optimize a report for the Power BI mobile apps. On your mobile phone, optimized reports have a special icon :::image type="icon" source="media/install-powerbi-desktop/power-bi-rs-mobile-optimized-icon.png" border="false":::, and layout.
  
    :::image type="content" source="media/install-powerbi-desktop/power-bi-rs-mobile-optimized-report.png" alt-text="Screenshot showing report optimized for phones.":::
