---
title: See what's new in Power BI with this month's update
...
- [**Quality improvements to language understanding for data questions**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc1284065238): Enhanced language understanding capabilities improve the accuracy of responses to data-related questions.
...
- [**Verified answers**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc1830912824): A feature that provides confidence in AI-generated answers by verifying their accuracy and relevance. Learn more about [verified answers](../create-reports/copilot-prepare-data-ai-verified-answers.md).
...
- [**Preparing a semantic model for AI**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc686463203): Steps to optimize your semantic model for seamless integration with AI features. Learn more about how to [prep your semantic model for AI](../create-reports/copilot-prepare-data-ai.md).
...
- [**Updates to the new list slicer (preview)**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc397869587): Improved functionality and customization options for the new list slicer.
...
- [**Upcoming Azure Maps tenant settings and layer ordering updates**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc91668847): New tenant settings and layer ordering features for Azure Maps.
- [**Upcoming changes to the Power BI app in Teams navigation menu**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc1862359525): Updates to the navigation menu in the Power BI app for Teams to improve usability.
- [**Visual updates for semantic models with discourage implicit measures enabled**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc896108075): Enhanced visual representation for semantic models when implicit measures are discouraged.

## Modeling

- [**Selection expressions for calculation groups**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc741903848): Define selection expressions for calculation groups to create dynamic calculations.
- [**TMDL view enhancements**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc342093751): Improvements to the TMDL view for better modeling experiences.
- [**Direct lake relationship improvements**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc867515150): Enhanced relationship handling for direct lake storage mode.
- [**Direct lake and import tables in the same semantic model**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc119482792): Support for combining direct lake and import tables within a single semantic model.

## Data connectivity

- [**New Google BigQuery connector implementation (preview)**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc824422523): A revamped connector for Google BigQuery with improved performance and features.
- [**Connect to the Vertica database with the user-installed ODBC driver - updates (preview)**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc89786441): Updates to the Vertica database connector for better compatibility with user-installed ODBC drivers.
- [**Connect to the Oracle database with the built-in driver - updates (preview)**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc721945319): Enhancements to the Oracle database connector using the built-in driver.
- [**Improvements in the Snowflake connector (preview)**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc1970163670): Updates to the Snowflake connector for improved data connectivity and performance.

## Visualizations

- [**Dandelion chart**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc1499679379): A new visualization option for representing hierarchical data in a dandelion-like structure.
- [**Dynamic radial bar chart by JTA**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc1698734417): A radial bar chart visualization with dynamic features for interactive data exploration.
...
- [**KPI by Powerviz**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc456234950): A new KPI visualization tool for tracking key performance indicators effectively.
- [**Drill down timeline PRO by ZoomCharts**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc1731426420): An advanced timeline visualization with drill-down capabilities for detailed analysis.
- [**PowerGantt chart by Nova Silva**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc2026347894): A Gantt chart visualization for project management and scheduling.
- [**Profitbase Gantt revamped**](https://powerbi.microsoft.com/blog/power-bi-may-2025-feature-summary/#post-29934-_Toc1762355889): An updated version of the Profitbase Gantt chart with enhanced features and usability.
