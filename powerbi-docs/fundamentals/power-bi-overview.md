...
![Screenshot of Diagram of Power B I Desktop, Service, and Mobile showing their integration.](media/power-bi-overview/power-bi-overview-blocks.png)
...
In the Power BI service, you can use the deployment pipeline tool to develop and test your content before you release it to your users. The deployment pipeline tool can help you deploy reports, dashboards, datasets, and paginated reports. Read about how to [get started with deployment pipelines](../create-reports/deployment-pipelines-get-started.md?tabs=paginated-reports) in the Power BI service.
...
![Screenshot of Diagram of Power B I Report Server, service, and mobile showing their integration.](media/power-bi-overview/power-bi-report-server2.png)
