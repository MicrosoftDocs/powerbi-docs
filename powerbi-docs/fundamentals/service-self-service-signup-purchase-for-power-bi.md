...
# Sign up or purchase Power BI and Fabric as an individual
...
Both the Power BI service and Fabric require all users to have access to a Fabric or Power BI capacity and to have a per-user license. The license options are Fabric (Free), Power BI Pro, or Premium Per User (PPU). 
