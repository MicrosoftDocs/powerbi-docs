...
![Power BI service](media/desktop-report-lifecycle-datasets/report-lifecycle_01.png)
...
![Publish](media/desktop-report-lifecycle-datasets/report-lifecycle_02a.png)
...
![Power BI service live connection](media/desktop-report-lifecycle-datasets/report-lifecycle_03.png)
...
![Login](media/desktop-report-lifecycle-datasets/report-lifecycle_04.png)
...
![Select a destination](media/desktop-report-lifecycle-datasets/report-lifecycle_05.png)

The publishing process begins, and **Power BI Desktop** shows the progress.

![Publish progress](media/desktop-report-lifecycle-datasets/report-lifecycle_06.png)
...
![Publish status](media/desktop-report-lifecycle-datasets/report-lifecycle_07.png)
...
![Connect to published data set](media/desktop-report-lifecycle-datasets/report-lifecycle_08.png)
...
![Select workspace](media/desktop-report-lifecycle-datasets/report-lifecycle_09a.png)
...
![Load data set](media/desktop-report-lifecycle-datasets/report-lifecycle_10.png)
