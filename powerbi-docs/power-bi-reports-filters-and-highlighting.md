...
In Reading View, explore the data by modifying the existing filters. Learn how in the article [Interact with filters in Reading view](service-interact-with-a-report-in-reading-view.md)
