...
## Embed your report
To embed your report into SharePoint Online, you need to get the report URL and use it with SharePoint Online's new Power BI web part.
...
2. Select the **+** dropdown and then select the **Power BI**.
