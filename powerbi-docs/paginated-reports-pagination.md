...
Image: Physical page with margins and usable area,
../../reporting-services/report-design/media/rspagemargins.gif "Physical page with margins and usable area."  
...
Image: Physical page with columns depicted, ../../reporting-services/report-design/media/rspagecolumns.gif "Physical page with columns depicted."  
...
-   ResetPageNumberindicates whether the page number should be reset to 1 when a page break occurs. If this property evaluates to True, the page number is reset.  
 ...
 You can use constants and simple or complex expressions to set the value of the Disabled and ResetPageNumber properties. However, you cannot use expression with the BreakLocation property. For more information about writing and using expressions, see Link Expressions in the Report Builder and SSRS articles, expressions-report-builder-and-ssrs.md.  
  
 In your report you can write expressions that reference the current page names or page numbers by using the **Globals** collection. For more information, see Link Built-in Globals and Users References in the Report Builder and SSRS articles, ../../reporting-services/report-design/built-in-collections-built-in-globals-and-users-references-report-builder.md.  
...
### Naming Excel Worksheet Tabs  
 ...
 For more information about how these properties work when reports are exported to Excel, see Link Exporting to Microsoft Excel in the Report Builder and SSRS content, ../../reporting-services/report-builder/exporting-to-microsoft-excel-report-builder-and-ssrs.md.  
