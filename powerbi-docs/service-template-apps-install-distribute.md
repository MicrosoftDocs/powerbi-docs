...
5. In **Get started with your new app**, select one of three options:
    ...
    >[!NOTE]
    >Installing a template app installed both an *organizational app* and an *workspace*. Read more about [distributing apps in Power BI](service-create-distribute-apps.md).
