...
description: Configure an workspace to store its dataflow definition and data files in Azure Data Lake Storage Gen2
...
To get started creating a dataflow from a CDM folder, launch the **Power BI service** and select an **workspace** from the left navigation pane. You can also create a new workspace, in which you can create your new dataflow.
