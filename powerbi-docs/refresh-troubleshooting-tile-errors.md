...
If you want to see the filtered data immediately, you can force a tile refresh by selecting the **More options** (...) in the upper right of a dashboard and selecting **Refresh dashboard tiles**.
