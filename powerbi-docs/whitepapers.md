...
| [Best design practices for reports and visuals](visuals/power-bi-visualization-best-practices.md) |Provides best practices for designing reports in Power BI. |
...
| [Power BI and SAP BW](https://aka.ms/powerbiandsapbw)| This document describes how SAP customers can benefit from connecting Power BI to their existing SAP Business Warehouse (BW) systems.|
| [Power BI Governance and Deployment Approaches](http://go.microsoft.com/fwlink/?LinkId=785915&clcid=0x409) | Provides concepts, options and suggestions for governance. While the process and organizational guidance in this paper is very valuable, some specific product guidance is out of date given the evolution of Power BI.  For specific Power BI implementation guidance, we recommend consulting the "Planning a Power BI Enterprise Deployment" whitepaper further up in this table. |
