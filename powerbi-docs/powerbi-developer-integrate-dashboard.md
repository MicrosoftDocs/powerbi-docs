...
> [!NOTE]
> Looking to embed a dashboard for your customers, using an embedtoken, instead? See, [Integrate a dashboard, tile, or report into your application for your customers](developer/embed-sample-for-customers.md).
> 
> 
