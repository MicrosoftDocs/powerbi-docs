...
1. In Power BI, open a report in [Reading View](service-report-open-in-reading-view.md) or [Editing View](service-reading-view-and-editing-view.md). Drill requires a visualization with a hierarchy. 
