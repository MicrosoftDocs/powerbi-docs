...
![](media/service-self-service-signup-for-power-bi/dashboard-report.png "Power BI dashboard and report")
...
This article will walk you through your options on how to sign up and begin using the Power BI service. To learn more about the differences in functionality between Power BI license types, take a look at [Power BI features by license type](service-features-license-type.md).
...
> [!NOTE]
> You can sign-up for Power BI with .gov or .mil addresses. For information take a look at [Enroll your US Government organization in the Power BI service](https://docs.microsoft.com/power-bi/service-govus-signup).
>

> [!NOTE]
> After you sign up you can [invite guest users](https://docs.microsoft.com/azure/active-directory/active-directory-b2b-what-is-azure-ad-b2b) to see content in your Power BI tenant with any email address including personal accounts.
>
...
### What this looks like within the service
When you are in the service, you can verify that you have a Pro trial account by going to the <strong>gear* icon and selecting **Manage personal storage</strong>.
