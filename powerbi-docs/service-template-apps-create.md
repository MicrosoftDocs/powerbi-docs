...
1. In the template app workspace, select **Create app**.
    ...
    **Navigation**
    ...
    Activate the **New navigation builder** where you can use define the left navigation pane of the app (See [Design the navigation experience](service-create-distribute-apps.md#design-the-navigation-experience) in this article for details).
