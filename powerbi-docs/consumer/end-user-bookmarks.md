...
1. **Region** filter is changed to include only **West** .
1. A specific data point on the donut chart visual is selected. This selection cross-filters and cross-highlights the other visuals on the report canvas.
