...
All of these visualizations can be found in Power BI apps, dashboards, reports, and [specified in Q&A](end-user-q-and-a.md). To learn how to interact with visualizations, see [Interact with visualizations in reports, dashboards, and apps](end-user-visualizations.md)

### Area charts: Basic (Layered) and Stacked
![area chart](media/end-user-visual-type/basicareamapsmall.png)
...
![column chart](media/end-user-visual-type/pbi_nancy_viz_bar.png)

 ![bar chart](media/end-user-visual-type/pbi_nancy_viz_col.png)

Bar charts are the standard for looking at a specific value across different categories.

### Cards: Single number
![single number card](media/end-user-visual-type/pbi_nancy_viz_card.png)
...
### Combo charts
![combo chart](media/end-user-visual-type/combosmall.png)
...
### Doughnut charts
![doughnut chart](media/end-user-visual-type/donutsmall.png)
...
### Funnel charts
![funnel chart](media/end-user-visual-type/pbi_nancy_viz_funnel.png)
...
### Gauge charts
![gauge chart](media/end-user-visual-type/gauge_m.png)
...
### Line charts
![line chart](media/end-user-visual-type/pbi_nancy_viz_line.png)

Line charts emphasize the overall shape of an entire series of values, usually over time.

### Maps: Basic maps
![basic map](media/end-user-visual-type/pbi-nancy_viz_map.png)
...
![filled map](media/end-user-visual-type/pbi_nancy_viz_filledmap.png)
...
### Pie charts
![pie chart](media/end-user-visual-type/pbi_nancy_viz_pie.png)
...
![bubble chart](media/end-user-visual-type/pbi_nancy_viz_bubble.png)
...
### Slicers
![slicer](media/end-user-visual-type/pbi_slicer.png)
...
### Standalone images
![standalone image](media/end-user-visual-type/pbi_nancy_viz_image.png)

A standalone image is a graphic that has been added to a report or dashboard. 


### Tables
![table chart](media/end-user-visual-type/tabletype.png)
...
### Treemaps
![treemap chart](media/end-user-visual-type/pbi_nancy_viz_tree.png)
...
### Waterfall charts
![waterfall chart](media/end-user-visual-type/waterfallsmall.png)
...
![q&a session](media/end-user-visual-type/qatreemap.png)
