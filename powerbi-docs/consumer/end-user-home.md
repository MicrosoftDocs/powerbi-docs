...
In Power BI, the term *content* refers to apps, dashboards, reports, and more. Content is created by Power BI designers who share it with their colleagues. Your content is accessible and viewable in the Power BI service. Power BI **Home** is the best place to start working in the Power BI service.
...
:::image type="content" source="media/end-user-home/power-bi-full-new.png" alt-text="A screenshot of the Welcome screen for the Power BI service." lightbox="media/end-user-home/power-bi-full-new.png#lightbox":::
...
This section of your Home contains links to the content that you visit most often or that you've tagged as a [favorite](end-user-favorite.md). These cards have black stars because they're tagged as favorites.
...
The **Featured** section contains content that your administrator or colleagues have promoted to your Home. Typically, this is content that's important or helpful for you to do your job. In this example, the featured content includes metrics to track success. Unless it's been disabled by your administrator, any user with Administrator, Member, or Contributor permissions to a workspace can feature content on Home. For more information about featuring content on Home, see [Feature content on colleagues' Power BI Home](../collaborate-share/service-featured-content.md)
...
Use the nav pane to locate and move between dashboards, reports, and apps. Occasionally, using the nav pane is the quickest way to get to content. The nav pane is there when you open your Home landing page and remains there as you open other areas of the Power BI service. It can be collapsed by selecting this icon ![Screenshot of icon with three horizontal lines.](media/end-user-home/power-bi-hide.png) .
  
The nav pane organizes your content into containers that are similar to what you've already seen on the Home canvas, like Apps, Data hub, Metrics, Knowledge center, and Workspaces. The Browse page contains your Recent, Favorites, and Shared with me. Select a container to see all the content.
