...
This article assumes that you've already read the [Power BI overview](../designer/power-bi-overview.md) and have identified yourself as a [Power BI ***consumer***](end-user-consumer.md). Consumers receive Power BI content, like dashboards and reports, from colleagues. Consumers use the Power BI service, which is the website-based version of Power BI.
