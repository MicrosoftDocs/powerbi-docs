...
A: No, copying and pasting the slicer visualization is not supported. This includes visuals that use [Visual Filter APIs(/power-bi/developer/visuals/filter-api)] which act as slicers. 
