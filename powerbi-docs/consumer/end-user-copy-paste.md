...
A: No, copying and pasting the slicer visualization is not supported. This includes visuals that use [Visual Filter APIs](../visuals/power-bi-visualization-copy-paste.md) which act as slicers. 
