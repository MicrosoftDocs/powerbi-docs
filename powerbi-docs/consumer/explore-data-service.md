...
Follow the steps in this article to learn how to use Explore (preview) to build a matrix or visual, customize your Exploration, and then save it to a workspace or as a report to share with others.
...
You can start your experience with Explore (preview) from various entry points:
...
- **Artifact in a list**:
   1. From a list, such as in a workspace or data hub, select **...** for more options.
...
To fully benefit from Explore (preview) in the Power BI service, be aware of the following permissions, requirements, and limitations.
