...
1. Begin exploring by building your matrix or PivotTable by adding fields from the data pane.

    > [!NOTE]
    > A matrix is like a PivotTable in Excel.

1. Add filters if you need them. 

1. Save and share your exploration. 
...
discover-business-insights.png


Or you may want to explore the underlying data behind a report. You can also begin exploration from the report **More options (…)** menu in a workspace list, or the **Explore this data** option on the report menu bar.

explore-data-report-menu-bar.png
...
explore-matrix-plus-visual.png
...
rearrange-data-columns-rows.png
...
To save and share your exploration, select the Save button in the top left corner.  
...
Now you’re ready to share your exploration with others. Select the **Share** button in the top left. 
 

 

Choose your audience and permissions by selecting the first section and selecting **Apply**. 
...
When you share, Power BI prompts you to grant build permissions to the underlying dataset so the recipient can view. If you skip this second dialog, the recipient can't see the exploration and will have to ask you for permissions.
