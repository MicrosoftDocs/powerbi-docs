...
1. Scroll down and enter the alert details.  In this example we'll create an alert that notifies us once a day if our market share increases to 40 or higher. Alerts will appear in our [Notification center](/power-bi/consumer/mobile/mobile-apps-notification-center). And we'll have Power BI send us an email as well.
