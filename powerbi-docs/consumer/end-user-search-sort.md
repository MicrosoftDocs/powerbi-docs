...
You can access search from almost every part of the Power BI service. Just look for the search box or search icon. :::image type="icon" source="./media/end-user-search-sort/power-bi-search-icon.png" border="false":::
...
:::image type="content" source="./media/end-user-search-sort/power-bi-search-field-new.png" alt-text="Screenshot of a search field with the term Sales entered.":::
...
:::image type="content" source="./media/end-user-search-sort/power-bi-workspaces-search.png" alt-text="Screenshot of a workspace showing two different search fields.":::

> [!NOTE]
> [B2B guest users](../collaborate-share/service-roles-new-workspaces.md) can't use search. If a guest user enters a search term, no results appear. 
...
:::image type="content" source="./media/end-user-search-sort/power-bi-shared-search.png" alt-text="Screenshot of the Shared with me content list displaying multiple items.":::
...
:::image type="content" source="./media/end-user-search-sort/power-bi-sort-z-to-a-new.png" alt-text="Screenshot of a content list sorted by the Name column.":::
...
:::image type="content" source="./media/end-user-search-sort/power-bi-sort-filters-new.png" alt-text="Screenshot of the filter options on a Recent content list.":::
