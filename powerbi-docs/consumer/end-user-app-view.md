---
title: Install and Use Power BI Apps
description: Learn how to install Power BI apps from the marketplace or direct links, open and interact with apps, and update them. Get started with apps today.
author: julcsc
...
1. When you find the app that you want, select **Get it Now** to install it.
   ...
   :::image type="content" source="./media/end-user-app-view/power-bi-get-now.png" alt-text="Screenshot of the Get it Now button to install an app.":::
...
1. Select the app to open it. Depending on the app, you might receive a prompt that looks similar to the following example. Some apps ask you for contact information (name and email) or for product details (customer ID, subscription number, or parameters). Many apps load with sample data and provide a link for you to connect your own data. For guidance on which option to select, see [Install template apps](../connect-data/service-template-apps-install-distribute.md).
   ...
   :::image type="content" source="./media/end-user-app-view/power-bi-customize.png" alt-text="Screenshot of the Get started page for a new app with the options Connect, Explore app, and Edit workspace.":::
