...
Report-level bookmark values of the format *BookmarkXXXXXXXXXXXXXXXXXXX* are not supported. Use a value in the standard GUID format instead. You can find the correct bookmarkGuid value in the link generated by the report's **Share** or **Chat in Teams** options.
