...
| **bookmarkGuid** | 36 character guid | Bookmark ID, if you want to open a specific bookmarked view. (if action is OpenReport)<br>Example: **bookmarkGuid=18e8872f-6db8-4cf8-8298-3b2ab254cc7f**<br>**Note**: Values of the format *BookmarXXXXXXXXXXXX* are not supported. Use a value in the standard GUID format instead. You can find the correct 36-character bookmarkGuid value in the link generated by the report's **Share** or **Chat in Teams** options.  |
...
Report-level bookmark values of the format *BookmarXXXXXXXXXXXX* are not supported. Use a value in the standard GUID format instead. You can find the correct bookmarkGuid value in the link generated by the report's **Share** or **Chat in Teams** options.
