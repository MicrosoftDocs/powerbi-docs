...
2. In the navigation pane, select **Workspaces** > **My Workspace**. Notice how the Retail Analysis Sample dashboard now has a yellow star indicating that it's a favorite.
