...
Power BI iOS app lets you protect your data by configuring additional identification. You'll need to provide Face ID, Touch ID, or a Passcode every time you launch the app or bring it from the background to the foreground
...
## Use a mobile device management (MDM) tool to enforce Face ID, Touch ID, or passcode protection
