...
1. Publish those reports to the Power BI service [(https://powerbi.com)](https://powerbi.com) or [Power BI Report Server](../../report-server/get-started.md).  
1. Interact with the reports in the Power BI mobile apps.
...
:::image type="content" source="./media/mobile-reports-in-the-mobile-apps/reports-my-workspace.png" alt-text="Screenshot of reports in My Workspace showing report icons.":::

There are two icons for reports in the Power BI mobile apps:

- :::image type="icon" source="./media/mobile-reports-in-the-mobile-apps/report-default-icon.png" border="false"::: indicates a report that will appear in landscape orientation in the app. It will look the same as it looks in a browser.
- :::image type="icon" source="./media/mobile-reports-in-the-mobile-apps/report-phone-icon.png" border="false"::: indicates a report that has at least one phone-optimized page that will appear in portrait orientation.
...
:::image type="content" source="./media/mobile-reports-in-the-mobile-apps/power-bi-android-open-report-tile.png" alt-text="Screenshot of More options menu with Open report option.":::
...
:::image type="content" source="./media/mobile-reports-in-the-mobile-apps/report-visual-menu.png" alt-text="Screenshot of visual with More options menu showing available actions.":::
...
:::image type="content" source="./media/mobile-reports-in-the-mobile-apps/report-drill-actions.png" alt-text="Screenshot of tooltip with drill down, drill up, and drill through options.":::
...
:::image type="content" source="./media/mobile-reports-in-the-mobile-apps/report-footer.png" alt-text="Screenshot of report footer showing available action buttons.":::
...
:::image type="content" source="./media/mobile-reports-in-the-mobile-apps/power-bi-mobile-report-all-actions.png" alt-text="Screenshot of all report actions menu showing complete list of available actions.":::
...
:::image type="content" source="./media/mobile-reports-in-the-mobile-apps/power-bi-mobile-report-bookmark-menu.png" alt-text="Screenshot of bookmark menu showing personal bookmarks and default bookmark options.":::

When a bookmark view of a report is open, the name of the bookmark appears at the top of the report.

:::image type="content" source="./media/mobile-reports-in-the-mobile-apps/power-bi-mobile-report-bookmark-title.png" alt-text="Screenshot of bookmark view showing bookmark name at top of report.":::
...
:::image type="content" source="media/mobile-reports-in-the-mobile-apps/mobile-detected-anomalies.png" alt-text="Screenshot of line chart that has anomaly indications.":::
...
:::image type="content" source="media/mobile-reports-in-the-mobile-apps/mobile-opening-anomalies-panel.png" alt-text="Screenshot showing how to open the anomalies panel.":::
...
:::image type="content" source="media/mobile-reports-in-the-mobile-apps/mobile-swipe-to-see-explanations.png" alt-text="Screenshot showing right to left swipe to view anomaly explanations.":::
...
:::image type="content" source="media/mobile-reports-in-the-mobile-apps/power-bi-mobile-report-refresh-info.png" alt-text="Screenshot of report refresh information on mobile-app.":::
