...
:::image type="content" source="media/mobile-reports-in-the-mobile-apps/power-bi-mobile-report-refresh-info.png" alt-text="Screenshot of report refresh info on mobile-app.":::
