...
The Power BI app for Windows 10 brings Power BI to your windows device. You get up-to-date, touch-enabled access to your business information. View and interact with your company dashboards from anywhere - right on your [Windows Start screen](mobile-pin-dashboard-start-screen-windows-10-phone-app.md).
...
Then interact with your dashboards and reports, explore the data, and share them, all from the Power BI app for Windows 10.
...
1. On the Start screen of your Windows 10 device, open the Power BI app.
   ...
   ![Power BI app icon](./media/mobile-windows-10-phone-app-get-started-classic/pbi_win10ph_appiconsm.png)
2. To view your Power BI dashboards and reports, tap **Power BI**. Sign in with the same credentials as your Power BI account on the web. 
   ...
   ![Connect dialog box](./media/mobile-windows-10-phone-app-get-started-classic/power-bi-windows-10-connect.png)
...
1. Tap the global navigation button ![Global navigation button](././media/mobile-windows-10-phone-app-get-started-classic/power-bi-windows-10-navigation-icon.png) in the upper-left corner.
2. Tap **Settings** icon ![Settings icon](./media/mobile-windows-10-phone-app-get-started-classic/power-bi-win10-settings-icon.png), tap your name, then tap **View samples**.
   
   ![View samples](./media/mobile-windows-10-phone-app-get-started-classic/power-bi-win10-view-samples.png)
3. Pick a role and explore the sample dashboard for that role.  
   
   ![Pick a role](./media/mobile-windows-10-phone-app-get-started-classic/power-bi-win10-samples.png)

### Reporting Services mobile report samples
1. Tap the global navigation button ![global navigation button](././media/mobile-windows-10-phone-app-get-started-classic/power-bi-windows-10-navigation-icon.png) in the upper-left corner.
2. Tap **Settings** icon ![Settings icon](./media/mobile-windows-10-phone-app-get-started-classic/power-bi-win10-settings-icon.png), right-click or tap and hold **Connect to server**, then tap **View samples**.
   
   ![Screenshot of the Settings screen, showing a pointer from the settings icon to connect to a server.](media/mobile-windows-10-phone-app-get-started-classic/power-bi-win10-connect-ssrs-samples.png)
3. Open the Retail Reports or Sales Reports folder to explore their KPIs and mobile reports.
   
   ![Screenshot of a report, showing  K P I and mobile reports.](media/mobile-windows-10-phone-app-get-started-classic/power-bi-win10-ssrs-sample-kpis.png)
...
1. Tap the search icon in the upper-right corner.
   ...
   ![Search icon](./media/mobile-windows-10-phone-app-get-started-classic/pbi_win10ph_searchbarbrdr.png)
   
   Power BI displays your most recent dashboards, reports, and apps.
   
   ![Search results](./media/mobile-windows-10-phone-app-get-started-classic/pbi_win10_searchrecent.png)
2. As you start typing, Power BI displays all relevant results.
   
   ![Relevant search results](./media/mobile-windows-10-phone-app-get-started-classic/pbi_win10_search_m.png)
...
![Power BI nav pane](./media/mobile-windows-10-phone-app-get-started-classic/power-bi-win10-left-nav.png)
...
* Tap **Favorites**.
   ...
   ![Favorites](./media/mobile-windows-10-phone-app-get-started-classic/power-bi-win10-favorite-menu.png)
  
   Your Power BI favorites and your favorites from the Reporting Services web portal are all on this page.
  
   ![View favorites](./media/mobile-windows-10-phone-app-get-started-classic/power-bi-win10-favorites.png)
