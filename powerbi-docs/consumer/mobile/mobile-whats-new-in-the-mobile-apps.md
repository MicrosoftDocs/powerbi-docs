...
**Bing dashboards** In the Power BI service, you can now create [dashboards with Bing search results](../power-bi-connect-to-services.md), and view them on your mobile device.
