...
**Power BI Desktop**
Also referred to as *Desktop*. The free Windows application of Power BI you can install on your local computer that lets you connect to, transform, and visualize your data. Used by report designers and admins. For more information, see [What is Power BI](../designer/power-bi-overview.md).
...
**Power BI service**
An online SaaS (Software as a service) service. For more information, see [What is Power BI](../designer/power-bi-overview.md).
