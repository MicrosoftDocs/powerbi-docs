...
:::image type="content" source="media/end-user-focus/power-bi-report.png" alt-text="Individual screenshots of a report view, focus mode, and full screen mode." Lightbox="media/end-user-focus/power-bi-reports.png":::
>>>>>>> 0c503460d027dc8fd874b257f9554b0d6c46955a

## When to use full screen mode

:::image type="content" source="media/end-user-focus/power-bi-dashboard-focus-mode.png" alt-text="Screenshot of a dashboard in full screen mode and default mode." lightbox="media/end-user-focus/power-bi-dashboard-focus.png":::
...
:::image type="content" source="media/end-user-focus/power-bi-compares.png" alt-text="Screenshot of a dashboard tile in default mode and then focus mode." lightbox="media/end-user-focus/power-bi-compare.png":::
