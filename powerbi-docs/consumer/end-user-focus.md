...
:::image type="content" source="media/end-user-focus/power-bi-report.png" alt-text="Individual screenshots of a report view, focus mode, and full screen mode." Lightbox="media/end-user-focus/power-bi-report.png":::
