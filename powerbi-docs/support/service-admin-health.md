...
Track Fabric service health using either the Fabric Admin Portal or the Microsoft 365 admin center to monitor current issues and view historical service data. Fabric admins can access these health monitoring tools to quickly identify and troubleshoot service problems. 
