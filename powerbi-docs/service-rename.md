...
2. Hover over the item to rename, select the **More options** (...), and choose **Rename**.  
...
2. In the top-right corner, select the **More options** (...) and choose **Edit workspace**. If you don't see this option, then you don't have permissions to rename this workspace. 
...
* On the **Datasets** tab, if you don't see the **More options** (...), expand your browser window.
