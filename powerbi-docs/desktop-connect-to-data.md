...
![Connect to data](media/desktop-connect-to-data/getdatavid_smallv2.gif)
...
![Get Data - Web](media/desktop-connect-to-data/connecttodata_3.png)
...
![Navigator dialog](media/desktop-connect-to-data/datasources_fromnavigatordialog.png)
...
![Edit query](media/desktop-connect-to-data/designer_gsg_editquery.png)
...
![Change data type](media/desktop-connect-to-data/designer_gsg_changedatatype.png)
...
![Report view](media/desktop-connect-to-data/connecttodata_dragontoreportview.png)
...
![Feedback](media/desktop-connect-to-data/sendfeedback.png)
