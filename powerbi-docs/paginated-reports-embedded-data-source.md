...
- Azure Analysis Services (using the SQL Server Analysis Services connection option)
- Power BI Premium Datasets (using the SQL Server Analysis Services connection option)
- Oracle 
- Teradata 
