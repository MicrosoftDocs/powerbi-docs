...
description: Find out about advanced incremental refresh and real-time data features with the XML for Analysis (XMLA) endpoint in Power BI.
author: JulCsc
...
:::image type="content" source="media/incremental-refresh-xmla/ssms-partitions.png" alt-text="Screenshot shows the Partitions window in SSMS.":::
