...
With each refresh operation, the service sends initialization/metadata queries to each data source. In some cases, you can improve incremental refresh performance by reducing the number of queries sent by doing the following: 
