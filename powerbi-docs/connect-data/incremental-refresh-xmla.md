...
With each refresh operation, the Power BI service sends initialization queries to each data source. In some cases, you can improve incremental refresh performance by reducing the number of initialization queries sent by doing the following: 
