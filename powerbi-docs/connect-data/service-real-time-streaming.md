...
1. On the next screen, enter a **Dataset name**, enter the following values into the next two fields, and then select **Next**.
   ...
   ![Screenshot of the New streaming semantic model dialog, showing how to create a Dataset name and entries in the Sub-key and Channel name fields.](media/service-real-time-streaming/real-time-streaming-8.png)
   
1. On the next screen, keep the automatically populated values, and select **Create**.
   
   ![Screenshot of the New streaming semantic model dialog, showing defaults for the Dataset name and Values from stream fields.](media/service-real-time-streaming/real-time-streaming-9.png)
...
#### How can you do modeling on real-time semantic modelc models?
