...
* Changing the data source connection string alias from xxxx.database.windows.net to xxxx.domain.com leads Power BI Service to understand it as a on-premises datasource and always requires a gateway connection to be established.
