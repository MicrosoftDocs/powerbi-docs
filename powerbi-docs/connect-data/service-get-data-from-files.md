...
> [!NOTE]
> Datasets imported from OneDrive for work or school or OneDrive Personal cannot be updated from local files. You must replace the file in OneDrive for work or school or OneDrive Personal for Power BI to update the dataset. Alternatively, delete the dataset and its related items and then import from a local file.
