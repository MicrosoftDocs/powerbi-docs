...
For more information about large datasets in Premium capacities, see [large datasets](../enterprise/service-premium-what-is.md#large-datasets). On A6 or P3 capacities, datasets can be refreshed to up to 12 GB.
...
Another way to consider the different refresh types is where you can apply them and what they impact. Changes in data source table structure, or schema, such as a new, renamed, or removed column can only be applied in Power BI Desktop, and in the Power BI service they can cause the refresh to fail. For a quick reference, refer to the following table.

Refresh operation | Refresh of report visuals | Data refresh | Schema refresh
---------|----------|---------|--------- 
