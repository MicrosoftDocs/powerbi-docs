...
1. Open the workspace that contains your semantic model.
1. Find your semantic model in the workspace content list.
1. Select **More options (...)** next to the semantic model name, and then select **Settings**.
1. Expand the **Gateway and cloud connections** section.
...
1. Open the semantic model settings page as described in the [Prerequisites](#prerequisites) section.
1. In the **Gateway and cloud connections** section, find **Cloud connections**.
1. Select the **Maps to** dropdown and choose the shareable cloud connection you want to use.
1. Select **Apply**.
