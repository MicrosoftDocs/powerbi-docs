...
> [!NOTE]
> SSO uses windows Authentication so make sure the windows acount can access the gateway machine. If not sure, make sure to add NT-AUTHORITY\Authenticated Users (S-1-5-11) to the local machine “Users” group.
