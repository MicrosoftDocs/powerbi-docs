...
> This option is not supported for scenarios that has multiple gateways as Active Directory enforces unique SPNs across an entire forest. for these scenarios, please use option A instead.
