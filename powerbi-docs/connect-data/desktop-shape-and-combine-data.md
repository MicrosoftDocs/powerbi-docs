...
1. The existing data is ordered by a weighted score, as described on the [source webpage](https://www.fool.com/research/best-states-to-retire) under *Methodology*. We'll then sort the table on this column to compare the custom score's ranking to the existing score.
