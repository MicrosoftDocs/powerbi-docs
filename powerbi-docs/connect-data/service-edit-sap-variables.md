...
> [!NOTE]
> If the link doesn't appear, manually refresh the semantic model by selecting it from the list in the **Datasets** tab of the workspace, and then selecting the **Refresh** icon.
