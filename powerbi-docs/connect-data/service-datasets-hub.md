...
* **Give your dataset a memorable icon**: You can make it easier for users to find and remember your dataset by giving it memorable icon. This makes your dataset stand out on the datasets hub page and anywhere else that supports displaying dataset icons.

    To give your dataset an icon, open your dataset's settings, and expand the dataset image section.
