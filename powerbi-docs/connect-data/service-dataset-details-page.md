...
| **Impact analysis** | Opens the [impact analysis side pane](../collaborate-share/service-semantic model-impact-analysis.md) for this semantic model. | **Lineage > Impact analysis** |
