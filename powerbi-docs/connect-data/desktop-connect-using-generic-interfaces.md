...
description: Learn how to connect different data sources with generic interfaces in Power BI Desktop using built-in data connectors.
...
![Screenshot of the Get Data dialog, showing the ODBC selection.](media/desktop-connect-using-generic-interfaces/generic-data-interfaces_1.png)
...
![Screenshot of the ODBC connector dialog, showing the DSN and Advanced options.](media/desktop-connect-using-generic-interfaces/generic-data-interfaces_2.png)
...
![Screenshot of the OLE DB connector dialog, showing the Connection string and Advanced options.](media/desktop-connect-using-generic-interfaces/generic-data-interfaces_3.png)
