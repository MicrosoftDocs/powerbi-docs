...
Calculate emissions from your tenant's usage of Microsoft 365 with the Emissions Impact Dashboard for Microsoft 365, now in preview.
...
>[!NOTE]
>This dashboard is currently in preview and only includes datacenter emissions associated with your organization's usage of Exchange Online, SharePoint, OneDrive for Business, Microsoft Teams, Word, Excel, and PowerPoint.
>
> Your historical emissions figures may be updated as Microsoft makes improvements to data accuracy and completeness.

## What's new

### Summer 2022 app version update

In the summer of 2022 we released a new version of the app that includes the following enhancements:
