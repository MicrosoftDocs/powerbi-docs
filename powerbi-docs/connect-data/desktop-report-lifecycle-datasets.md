...
![Screenshot that shows selecting Power BI semantic models in the Power BI Desktop Get data screen.](media/desktop-report-lifecycle-semantic models/report-lifecycle_01.png)
...
![Screenshot shows the Publish button in Power BI Desktop.](media/desktop-report-lifecycle-semantic models/report-lifecycle_02a.png)
...
![Diagram that shows multiple reports based on the same semantic model.](media/desktop-report-lifecycle-semantic models/report-lifecycle_03.png)
...
1. To publish the report, from Power BI Desktop, select **Publish** from the **Home** tab.
   ...
   ![Screenshot that shows publishing a report.](media/desktop-report-lifecycle-semantic models/report-lifecycle_02a.png)

   If you're not signed in to the Power BI service account, Power BI prompts you to sign in.

   ![Screenshot that shows sign in to Power BI Desktop.](media/desktop-report-lifecycle-semantic models/report-lifecycle_04.png)
...
1. Select the workspace destination to publish the report and semantic model to, and choose **Select**. Anyone who has Build permission can then access that semantic model. You can set Build permission in the Power BI service after publishing.
   ...
   ![Screenshot that shows Publish to the Power BI service.](media/desktop-report-lifecycle-semantic models/report-lifecycle_05.png)

   The publishing process begins, and Power BI Desktop shows the progress.

   ![Screenshot that shows publishing in progress.](media/desktop-report-lifecycle-semantic models/report-lifecycle_06.png)
   ...
   ![Screenshot that shows publishing succeeded.](media/desktop-report-lifecycle-semantic models/report-lifecycle_07.png)
...
1. The last step is to set Build permission in the Power BI service for the semantic model the report is based on. Build permission determines who can see and use your semantic model. You can set Build permission in the workspace itself, or when you share an app from the workspace. For more information, see [Build permission for shared semantic models](service-semantic models-build-permissions.md).
...
1. The **Data hub** shows the workspaces you're a member of, and all the shared semantic models you have Build permission for in any workspace.
   ...
   ![Screenshot that shows the list of available semantic models.](media/desktop-report-lifecycle-semantic models/desktop-select-shared-semantic model.png)
...
1. Select a semantic model, and then select **Connect** to establish a live connection to the selected semantic model. Power BI Desktop loads the semantic model fields and their values in real time.
   ...
   ![Screenshot that shows semantic model fields in the Fields pane.](media/desktop-report-lifecycle-semantic models/report-lifecycle_10.png)
...
- [Using DirectQuery for Power BI semantic models and Azure Analysis Services (preview)](../connect-data/desktop-directquery-semantic models-azure-analysis-services.md)
