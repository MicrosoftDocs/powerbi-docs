...
If Members are required to publish, they need to download using the option "A Copy of your report and data". Make the necessary changes and then publish the report.
