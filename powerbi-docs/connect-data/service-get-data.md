...
- **Dataset size limit**. Datasets stored in shared capacities in the Power BI service have a 1-GB size limit. For larger semantic models, use [Power BI Premium](../enterprise/service-premium-what-is.md).
