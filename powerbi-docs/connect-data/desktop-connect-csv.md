...
![Screenshot of Get Data menu on the Home ribbon.](media/desktop-connect-csv/connect-to-csv_1.png)

Select your CSV file from the **Open** dialog that appears.

![Screentshot of Open dialog that appears when C S V option is selected in the Get Data option is selected.](media/desktop-connect-csv/connect-to-csv_2.png)
...
![Screenshot of Power B I desktop window showing the Fields pane after loading data.](media/desktop-connect-csv/connect-to-csv_4.png)
