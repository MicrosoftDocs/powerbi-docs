...
- All connections to remote Power BI Datasets models are made using single sign-on. Notice that authenticating with [a service principal](../developer/embedded/embed-service-principal) is not supported as this time.
