...
- In Power BI Desktop: from the **Home** ribbon, select **Get data** > **Power BI semantic models**.
    ...
    :::image type="content" source="media/service-datasets-across-workspaces/power-bi-connect-semantic model-pk.png" alt-text="Screenshot shows how to connect to an existing semantic model in the Power BI service and Power BI Desktop." lightbox="media/service-datasets-across-workspaces/power-bi-connect-semantic model-pk.png":::
