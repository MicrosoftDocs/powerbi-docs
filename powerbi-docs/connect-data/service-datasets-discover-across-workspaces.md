...
> [!NOTE]
> If you're a free user, you see only datasets in your **My workspace**, or datasets for which you have Build permission that are in Premium or Fabric capacity workspaces. A Power BI Pro, Power BI Premium Per User license, or Power BI Individual trial is required to build on semantic models across workspaces.
...
- In the Power BI service: **OneLake catalog**.
- In Power BI Desktop: **Get data** > **Power BI semantic models**.

  In **OneLake catalog**, select **Endorsed in your org**.
