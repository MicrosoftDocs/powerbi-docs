...
> [!IMPORTANT]
> SAP no longer supports the gx64krb5, and as a result, Microsoft also has discontinued its support. Existing and new connections will continue to work properly until the end of 2020, but will not work from January 2021 onwar. Use CommonCryptoLib instead. 
