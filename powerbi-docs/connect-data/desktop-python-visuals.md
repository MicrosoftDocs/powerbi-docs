...
This tutorial helps you get started creating visuals with Python data in Power BI Desktop. You use a few of the many options and capabilities for creating visual reports using Python, pandas, and the Matplotlib library.
...
1. In the **Python script editor**, under **Paste or type your script code here**, enter this code:
   ...
   The Matplotlib library imports to plot and create the visuals.

1. Select the **Run** script button to generate the following scatter plot in the Python visual image.
...
Create a line plot for each person that shows their number of children and pets. Remove or comment out the previous code under **Paste or type your script code here**, and enter the following Python code:
...
Create a bar plot for each person's age. Remove or comment out the previous code under **Paste or type your script code here**, and enter the following Python code:
