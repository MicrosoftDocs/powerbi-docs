...
| Retains audit data, even if the tenant is moved to a different Azure region. | Does not retain activity data when the tenant is moved to a different Azure region. |
| | |
