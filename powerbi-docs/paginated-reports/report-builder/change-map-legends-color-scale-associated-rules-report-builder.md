---
title: Change Map Legends, Color Scale, Associated Rules in a Power BI Paginated Report
...
1.  In **Position**, select the location that specifies where to display the legend relative to the viewport.  
...
1.  Right-click the layer that has the data that you want and then select _\<map element type>_**Color Rule**.  
  
1.  Select **Legend**.  
  
1.  In the **Show in this legend** drop-down list, select the name of the legend to display the rule results in.  
...
1.  In **Data field**, type the name of the field that contains the analytical data that you want to visualize by color.  
  
1.  In **Palette**, from the drop-down list, select the name of the palette to use.  
...
1.  In **Number of subranges**, type the number of subranges to use. When the distribution type is **Optimal**, the number of subranges is automatically calculated.  
  
1.  In **Range start**, type a minimum range value. All values less than this number are the same as the range minimum.  
  
1.  In **Range end**, type a maximum range value. All values larger than this number are the same as the range maximum.  
...
1.  Right-click the layer that has the data that you want, and then select _\<map element type>_**Rule**.  
  
1.  Verify that **Visualize data by using** \<*rule type*> is selected.  
  
1.  In **Data field**, verify that the analytical data that you are visualizing on the layer is selected.  
