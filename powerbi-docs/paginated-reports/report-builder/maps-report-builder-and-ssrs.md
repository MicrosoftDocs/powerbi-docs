...
##  <a name="Viewport"></a> Understanding the Map Viewport  
 ...
 ![Screenshot showing the Map Viewport.](../media/paginated-reports-maps/map-view-port.gif "MapViewPort") 
...
-   **Point Layer.** Displays markers for point locations.  
 ...
 ![Screenshot of the Map Layers section that points out the Layer Toolbar, Layer visibility, Layer name, Type of spacial data source, Layer type, Adjust Zoom Level, and Adjust View Center options.](../media/paginated-reports-maps/map-layer-zone.gif "MapLayerZone")  
