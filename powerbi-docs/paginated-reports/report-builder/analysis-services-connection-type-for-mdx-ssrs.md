...
description: Learn details about the Analysis Services Connection type for MDX (paginated reports in Power BI) so you can retrieve metadata for use as report data.
ms.date: 01/17/2017
...
ms.author: maggies
---
# Analysis Services Connection Type for MDX (Paginated Reports in Power BI)
