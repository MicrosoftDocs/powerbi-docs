...
## Default mode  
 ...
 ![Screenshot showing Grouping pane for nested row and column groups](../media/basic-tablix-design-grouping-pane-default-view.gif "Grouping pane for nested row and column groups")  
