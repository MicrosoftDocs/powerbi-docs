...
description: Learn about the Grouping pane on the report menu in Power BI Services that displays the row groups and column groups for the currently selected Tablix data region.
ms.date: 05/15/2023
ms.service: powerbi
...
## Default mode  
 ...
 ![Screenshot showing Grouping pane for nested row and column groups](../report-builder/media/basic-tablix-design-grouping-pane-default-view.gif "Grouping pane for nested row and column groups")  
...
-   **ToggleItem.** String. The name of the text box to which to add the toggle image. The text box must be in the same group scope or a containing scope.  
 ...
 For more information about how this behavior can be controlled on a Tablix data region, see [Controlling the Tablix Data Region Display on a Report Page &#40;Power BI Report Builder&#41;](/sql/reporting-services/report-design/controlling-the-tablix-data-region-display-on-a-report-page).  
