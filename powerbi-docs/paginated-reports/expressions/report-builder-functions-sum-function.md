...
description: The Sum function in Power BI Report Builder returns the sum of all the non-null numeric values in a paginated report specified by the expression.
author: maggiesMSFT
ms.author: maggies
ms.reviewer: rpatkar
ms.date: 06/16/2023
...
---
# Report Builder functions - Sum function in a paginated report (Power BI Report Builder)
