...
|Direct Lake models|SSO|For more details on how to create reports using Direct Lake models and permissions required, see [Building reports on Direct Lake.](/fabric/fundamentals/building-reports)|
