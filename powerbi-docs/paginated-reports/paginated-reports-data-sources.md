...
|Direct Lake models|SSO|For more details on how to create reports using Direct Lake models and permissions required, see [this article](/fabric/fundamentals/building-reports).|
