...
|**OutputFormat**|One of the [!INCLUDE[ndptecgdiexpanded](/sql/includes/ndptecgdiexpanded-md)] ([!INCLUDE[ndptecgdi](/sql/includes/ndptecgdi-md)]) supported output formats: **BMP**, **EMF**, **GIF**, **JPEG**, **PNG**, or **TIFF**.|  
