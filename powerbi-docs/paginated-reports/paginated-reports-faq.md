...
Power BI tenant admins can modify the default maximum memory percentage in the Admin portal. See the **Paginated Reports** workload section under **Powre BI Premium** on the **Capacity settings** tab.
