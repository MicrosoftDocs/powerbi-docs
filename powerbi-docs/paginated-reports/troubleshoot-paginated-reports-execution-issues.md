...
We’re having trouble connecting to the service. Please check your network connection or VPN settings, then try again. If the issue continues, there may be a network policy or firewall blocking required access. [Learn more](./troubleshoot-paginated-reports-execution-issues#why-do-i-get-an-error-communicating-with-analysis-service-message)
