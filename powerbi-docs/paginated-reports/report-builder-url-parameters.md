...
For examples of passing report parameters in a URL, see [Pass a report parameter in a URL](../parameters/pass-a-report-parameter-within-a-url.md).
...
- [Pass a report parameter in a URL for a paginated report in Power BI](../parameters/pass-a-report-parameter-within-a-url.md)
