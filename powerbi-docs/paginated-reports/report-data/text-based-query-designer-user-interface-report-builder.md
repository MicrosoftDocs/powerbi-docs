...
|![Run the query](../media/report-builder-data/rsqdicon-run.gif "Run the query")|Run the query and display the result set in the Result pane.|  
...
### Command Type Text  
 When you create a SQL Server dataset, the relational query designer opens by default. To switch to the text-based query designer, click the **Edit As Text** toggle button on the toolbar. The text-based query designer presents two panes: the Query pane and the Result pane. The following figure labels each pane.  
  
 ![Generic query designer, for relational data query](../media/report-builder-data/rsqd-dsaw-sql-generic.gif "Generic query designer, for relational data query")  
...
### Command Type StoredProcedure  
 ...
 ![Stored procedure in text-based query designer](../media/report-builder-data/rs-relational-text-sp.gif "Stored procedure in text-based query designer")  
