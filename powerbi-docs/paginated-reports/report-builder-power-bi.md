...
Create a data source connection, drag and drop fields to create a dataset query, select a layout, add accessibility row properties, and style, and customize your report.  
