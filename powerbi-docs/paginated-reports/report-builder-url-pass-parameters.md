...
> 
> Power BI does not support a query string of more than 2000 characters.  This value can be exceeded if you are using url parameters to view your paginated report.  It is especially true if you are using multi-value parameters.
