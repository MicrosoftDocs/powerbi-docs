---
title: Set Text Box Orientation in a Power BI Paginated Report
...
1.  If the Properties pane is not open, on the **View** tab, select the **Properties** check box.  
  
1.  In the Properties pane, find the WritingMode property and select the text orientation to apply to the text box.  
  
    > [!NOTE]  
    >  When the properties in the Properties pane are organized into categories, WritingMode is in the **Localization** category.  
  
1.  In the list box, select **Horizontal**, **Vertical**, or **Rotate270**.  
