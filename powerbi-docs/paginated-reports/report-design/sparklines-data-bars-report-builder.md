---
title: Sparklines and Data Bars in a Power BI Paginated Report
...
[!INCLUDE [applies-yes-report-builder-no-desktop](../../includes/applies-yes-report-builder-no-desktop.md)]
 ...
 :::image type="content" source="media/sparkline-example.gif" alt-text="Screenshot of a Sparkline Example." lightbox="media/sparkline-example.gif":::  
...
##  <a name="DataBars"></a> Data bars  
 ...
 :::image type="content" source="media/data-bars.gif" alt-text="Screenshot of a Data Bars." lightbox="media/data-bars.gif":::  
...
##  <a name="AlignDatainTableMatrix"></a> Align sparkline data in a table or matrix  
 ...
 :::image type="content" source="media/sparkline-align-data.gif" alt-text="Screenshot of a Sparkline Align Data." lightbox="media/sparkline-align-data.gif":::  
