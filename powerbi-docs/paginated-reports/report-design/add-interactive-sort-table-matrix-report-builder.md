---
title: Add Interactive Sort to a Table or Matrix in Power BI Paginated Reports
...
1.  Repeat steps 1-6 for every column to which you want to add an interactive sort button.  
 ...
 :::image type="content" source="media/up-arrow.gif" alt-text="Screenshot of an arrow icon used with Back to Top link." lightbox="media/up-arrow.gif"::: [Back to Top](#BackToTop)  
