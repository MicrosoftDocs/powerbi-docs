---
title: Control Row & Column Headings in a Power BI Paginated Report
...
###  <a name="Matrix"></a> Matrix  
 ...
 :::image type="content" source="media/basic-matrix-design.gif" alt-text="Screenshot of a Matrix, Category row and Geography column group." lightbox="media/basic-matrix-design.gif":::  
 ...
 :::image type="content" source="media/basic-matrix-preview.gif" alt-text="Screenshot of a Preview for rendered matrix with expanded groups." lightbox="media/basic-matrix-preview.gif":::  
...
###  <a name="TableNoGroups"></a> Table with no row groups  
 ...
 :::image type="content" source="media/table-header-static-design.gif" alt-text="Screenshot of a Design, table with one static, one dynamic row." lightbox="media/table-header-static-design.gif":::  
 ...
 :::image type="content" source="media/table-header-static-preview.gif" alt-text="Screenshot of a Preview, table with one static, one dynamic row." lightbox="media/table-header-static-preview.gif":::  
 ...
 :::image type="content" source="media/table-header-static-grouping-pane-default.gif" alt-text="Screenshot of a Row Groups, table with 1 static, 1 dynamic row." lightbox="media/table-header-static-grouping-pane-default.gif":::  
  
 In Advanced mode, the following figure shows the static and dynamic tablix members for the row groups in the table:  
  
 :::image type="content" source="media/table-header-static-grouping-pane-advanced.gif" alt-text="Screenshot of a Row Groups, Advanced for default table." lightbox="media/table-header-static-grouping-pane-advanced.gif":::  
...
###  <a name="TableRowGroupsGroupHeader"></a> Table with row groups and a row group area  
 ...
 :::image type="content" source="media/table-header-dynamic-group-header-cell-design.gif" alt-text="Screenshot of a Design, table with one row group and details." lightbox="media/table-header-dynamic-group-header-cell-design.gif":::  
 ...
 :::image type="content" source="media/table-header-dynamic-group-header-cell-preview.gif" alt-text="Screenshot of a Preview, table with one row group and details." lightbox="media/table-header-dynamic-group-header-cell-preview.gif":::  
 ...
 :::image type="content" source="media/table-header-dynamic-grouping-pane-default.gif" alt-text="Screenshot of a Row Groups, Default with dynamic members." lightbox="media/table-header-dynamic-grouping-pane-default.gif":::  
  
 Use the **Advanced** mode of the Row Groups pane to display the tablix members, as shown in the following figure:  
  
 :::image type="content" source="media/table-header-dynamic-group-header-cell-advanced.gif" alt-text="Screenshot of a Row Groups, Advanced mode with static members." lightbox="media/table-header-dynamic-group-header-cell-advanced.gif":::  
...
-   Upgrade a report that was created for a previous RDL version, before tablix data regions were introduced.  
 ...
 :::image type="content" source="media/table-header-dynamic-no-group-header-cell-design.gif" alt-text="Screenshot of a Design, table has row group but no group header." lightbox="media/table-header-dynamic-no-group-header-cell-design.gif":::  
 ...
 :::image type="content" source="media/table-header-dynamic-no-group-header-cell-preview.gif" alt-text="Screenshot of a Preview, table has row group but no group header." lightbox="media/table-header-dynamic-no-group-header-cell-preview.gif":::  
 ...
 :::image type="content" source="media/table-header-dynamic-no-group-header-cell-advanced.gif" alt-text="Screenshot of a Row Groups, Advanced, no group header." lightbox="media/table-header-dynamic-no-group-header-cell-advanced.gif":::  
