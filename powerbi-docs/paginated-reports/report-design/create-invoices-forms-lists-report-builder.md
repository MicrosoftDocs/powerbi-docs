---
title: Create Invoices and Forms with Lists in a Power BI Paginated Report
...
##  <a name="AddingList"></a> Add a list to your report  
 ...
 :::image type="content" source="media/list-template-new.gif" alt-text="Screenshot of a New List report item on the design surface." lightbox="media/list-template-new.gif":::  
  
 When you select a list on the design surface, row and column handles appear, as shown in the following figure.  
  
 :::image type="content" source="media/list-template-new-selected.gif" alt-text="Screenshot of a New List added from Toolbox, selected." lightbox="media/list-template-new-selected.gif":::  
...
##  <a name="DisplayingLayout"></a> Display data in a free-form layout  
 ...
 :::image type="content" source="media/basic-list-form-design.gif" alt-text="Screenshot of a List in design view, 4 fields and an image." lightbox="media/basic-list-form-design.gif":::  
  
 In Preview, the list repeats to display the field data in the free-form format, as shown in the following figure:  
  
 :::image type="content" source="media/basic-list-form-preview.gif" alt-text="Screenshot of a Preview for List with 4 fields and one image." lightbox="media/basic-list-form-preview.gif":::  
...
##  <a name="DisplayingGrouping"></a> Display data with one level of grouping  
 ...
 :::image type="content" source="media/basic-list-group-design.gif" alt-text="Screenshot of a list with 2 tables, one with nested chart." lightbox="media/basic-list-group-design.gif":::  
 ...
 :::image type="content" source="media/basic-list-group-preview.gif" alt-text="Screenshot of a Preview, 2 tables, one with nested chart." lightbox="media/basic-list-group-preview.gif":::  
