---
title: Create a Matrix in a Power BI Paginated Report
...
##  <a name="AddingMatrix"></a> Add a matrix to your report  
 ...
 :::image type="content" source="media/matrix-template-new.gif" alt-text="Screenshot of a Blank Matrix with 1 row and 1 column group." lightbox="media/matrix-template-new.gif":::  
  
 When you select a matrix on the design surface, row and column handles appear, as shown in the following figure.  
  
 :::image type="content" source="media/matrix-template-new-selected.gif" alt-text="Screenshot of a New Matrix added from Toolbox, selected." lightbox="media/matrix-template-new-selected.gif":::  
...
-   In the new column, a row group cell appears for the default data rows from the report dataset. Cells in the tablix body for this row are now members of the row group. If there are any column groups defined, cells that are in the columns are members of those column groups. Group indicators provide visual cues for the group membership of each cell.  
 ...
 :::image type="content" source="media/basic-matrix-nested-groups-totals-design.gif" alt-text="Screenshot of a Matrix, nested row and column groups with totals." lightbox="media/basic-matrix-nested-groups-totals-design.gif":::  
  
 In preview, the report displays as in the following figure.  
  
 :::image type="content" source="media/basic-matrix-nested-groups-totals-preview.gif" alt-text="Screenshot of a Nested Groups in Preview." lightbox="media/basic-matrix-nested-groups-totals-preview.gif":::  
...
##  <a name="AddingAdjacentGroup"></a> Add an adjacent group to a matrix  
 ...
 :::image type="content" source="media/basic-matrix-adjacent-groups-design.gif" alt-text="Screenshot of an adjacent Column Groups for Geography and Year." lightbox="media/basic-matrix-adjacent-groups-design.gif":::  
 ...
 :::image type="content" source="media/basic-matrix-adjacent-groups-preview.gif" alt-text="Screenshot of a Preview of adjacent column groups." lightbox="media/basic-matrix-adjacent-groups-preview.gif":::  
