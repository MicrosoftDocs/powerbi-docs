---
title: Charts in Power BI Paginated Reports
...
The more time you spend carefully preparing and understanding your data before you create a chart, the easier it will be to design your charts quickly and efficiently. For help with choosing which chart to use, see [Chart Types](/sql/reporting-services/report-design/chart-types-report-builder-and-ssrs) To start experimenting with charts immediately, see the bar, column, sparkline, and pie chart tutorials in [Power BI Report Builder Tutorials](/sql/reporting-services/report-builder-tutorials).  
 ...
 :::image type="content" source="media/paginated-reports-visualizations/chart-elements-c.png" alt-text="Screenshot of a Chart elements diagram." lightbox="media/paginated-reports-visualizations/chart-elements-c.png":::  
...
##  <a name="DesigningChart"></a> Design a chart  
 ...
 :::image type="content" source="media/paginated-reports-visualizations/chart-series-categories.gif" alt-text="Screenshot of chart showing the chart properties." lightbox="media/paginated-reports-visualizations/chart-series-categories.gif":::  
...
##  <a name="SimilarMatrix"></a> How a chart is like a matrix  
 ...
 :::image type="content" source="media/paginated-reports-visualizations/matrix-template-new-selected.gif" alt-text="Screenshot showing a matrix template." lightbox="media/paginated-reports-visualizations/matrix-template-new-selected.gif":::  
...
##  <a name="AddingData"></a> Add data to the chart  
 ...
 :::image type="content" source="media/paginated-reports-visualizations/chart-no-series.gif" alt-text="Screenshot showing how to add data to the chart." lightbox="media/paginated-reports-visualizations/chart-no-series.gif":::  
