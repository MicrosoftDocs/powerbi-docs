---
title: "Formatting scales on a gauge in Power BI paginated report | Microsoft Docs"
...
---
# Formatting scales on a gauge in Power BI paginated report (Power BI Report Builder)
...
-   On a linear gauge, you can specify the width of the start and end margins relative to the endpoints on a linear gauge.  
 ...
 To quickly get started with formatting scales, see [Set a Minimum or Maximum on a Gauge &#40;Power BI Report Builder&#41;](set-minimum-maximum-on-gauge-report-builder.md).  
