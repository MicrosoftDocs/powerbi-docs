---
title: Format Scales on a Gauge in Power BI Paginated Report
...
[!INCLUDE [applies-yes-report-builder-no-desktop](../../../includes/applies-yes-report-builder-no-desktop.md)]
 ...
 :::image type="content" source="./media/paginated-reports-visualizations/scale-overview-diagram.gif" alt-text="Screenshot of a Overview of elements on a gauge scale." lightbox="./media/paginated-reports-visualizations/scale-overview-diagram.gif":::  
...
##  <a name="ReducingCollisions"></a> Reduce label collisions with multipliers
 ...
 If your values contain many digits, they might begin to obscure the readability of the gauge. You can use a scale multiplier to increase or reduce the scale of the values. When a scale multiplier is specified, each original value on the scale is multiplied by the multiplier before being displayed on the scale. To reduce the scale of values, you must specify a decimal number. For example, if your scale goes from 0 to 10000 but you want to show the numbers 0 to 10 on the gauge, you can use a multiplier value of 0.001.  
...
> When you click the scale of a gauge, a dotted outline appears around the scale. This outline is not the scale bar, and it is not used when calculating measurements on the gauge. It is available only at design time so that you can highlight the scale in order to access the scale properties.  
 ...
 :::image type="content" source="./media/paginated-reports-visualizations/scale-radius-diagram.gif" alt-text="Screenshot of a Scale radius relative to gauge diameter." lightbox="./media/paginated-reports-visualizations/scale-radius-diagram.gif":::  
