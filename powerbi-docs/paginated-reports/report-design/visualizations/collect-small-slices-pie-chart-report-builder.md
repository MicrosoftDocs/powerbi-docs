---
title: Collect Small Slices on Power BI Paginated Report Pie Chart
...
Pie charts with too many slices can look cluttered. Learn to collect many small slices in a pie chart into one single slice in paginated reports.
 ...
 :::image type="content" source="./media/paginated-reports-visualizations/report-builder-pie-chart-other-slice.png" alt-text="Screenshot of a Report Builder pie chart showing the other slice." lightbox="./media/paginated-reports-visualizations/report-builder-pie-chart-other-slice.png":::
...
1.  On the design surface, select any slice of the pie chart. The properties for the series are displayed in the Properties pane.  
  
1.  In the **General** section, expand the **CustomAttributes** node.  
  
1.  Set the CollectedStyle property to **SingleSlice**.  

    :::image type="content" source="./media/paginated-reports-visualizations/report-builder-pie-chart-single-slice-property.png" alt-text="Screenshot of a report builder pie chart showing how to configure a single slice property." lightbox="./media/paginated-reports-visualizations/report-builder-pie-chart-single-slice-property.png":::
  
1.  Set the collected threshold value and type of threshold. The following examples are common ways of setting collected thresholds.  
...
1.  Set the CollectedLabel property to a string that represents the text label that's shown on the collected slice.  
  
1.  (Optional) Set the CollectedSliceExploded, CollectedColor, CollectedLegendText and CollectedToolTip properties. These properties change the appearance, color, label text, legend text and tooltip aspects of the single slice.  
  
## Collect small slices into a secondary, callout pie chart  
  
1.  Follow Steps 1-3 from above.  
  
1.  Set the CollectedStyle property to **CollectedPie**.  
  
1.  Set the CollectedThresholdproperty to a value that represents the threshold at which small slices are collected into one slice. When the CollectedStyle property is set to **CollectedPie**, the CollectedThresholdUsePercentproperty is always set to **True**, and the collected threshold is always measured in percent.  
  
1.  (Optional) Set the CollectedColor, CollectedLabel, CollectedLegendText and CollectedToolTip properties. All other properties named "Collected" don't apply to the collected pie.  
