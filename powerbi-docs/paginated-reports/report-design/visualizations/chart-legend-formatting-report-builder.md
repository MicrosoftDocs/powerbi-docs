...
# Chart legend - formatting the legend on a paginated report chart (Power BI Report Builder)
 ...
 ![Screenshot showing chart legend](/powerbi-docs/paginated-reports/media/paginated-reports-visualizations/legenddiagram.gif "Diagram of a chart legend")  
