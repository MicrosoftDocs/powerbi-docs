---
title: Format Power BI Paginated Report Items
...
**Applies to:** [!INCLUDE [applies-to-report-builder](../../includes/applies-to-version/report-builder.md)]
 ...
 :::image type="content" source="../report-design/media/text-label-placeholder.png" alt-text="Screenshot showing text label placeholder." lightbox="../report-design/media/text-label-placeholder.png":::  
