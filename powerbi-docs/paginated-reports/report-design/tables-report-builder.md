---
title: Tables in Power BI Paginated Reports
...
##  <a name="AddingTable"></a> Add a table to display detail data  
 ...
 :::image type="content" source="media/table-template-new.gif" alt-text="Screenshot of a Table template." lightbox="media/table-template-new.gif":::  
 ...
 :::image type="content" source="media/table-template-new-selected.gif" alt-text="Screenshot of a Table template on design surface, selected." lightbox="media/table-template-new-selected.gif":::  
  
 The row handle for the Data row shows the details symbol (:::image type="content" source="media/icon-tablix-details-row.gif" alt-text="Screenshot of a Row handle with 3 parallel lines for details row." lightbox="media/icon-tablix-details-row.gif":::). To display data on these rows, drag fields from the Report Data pane to the table cells in either the header or the details row. Both rows are filled in simultaneously. To add additional columns, drag the field to the table until you see an insertion point. After you add dataset fields to the table, you can change the default format for dates and currency to control the way they display in the report. The following diagram shows a table data region with these fields: Date, Order, Product, Qty, and Line Total.  
  
 :::image type="content" source="media/basic-table-details-formatted-design.gif" alt-text="Screenshot of a Design, Table with column headers in Bold." lightbox="media/basic-table-details-formatted-design.gif":::  
 ...
 :::image type="content" source="media/basic-table-details-formatted-preview.png" alt-text="Screenshot of a Preview of table with bold column headers." lightbox="media/basic-table-details-formatted-preview.png":::  
...
### Add totals for detail data  
 ...
 :::image type="content" source="media/basic-table-details-total-design.gif" alt-text="Screenshot of a Total row added to table." lightbox="media/basic-table-details-total-design.gif":::  
 ...
 :::image type="content" source="media/basic-table-details-total-preview.gif" alt-text="Screenshot of a Preview with table and total row." lightbox="media/basic-table-details-total-preview.gif":::  
...
##  <a name="AddingRowGroups"></a> Add row groups to a table  
 ...
 :::image type="content" source="media/basic-table-groups-design.gif" alt-text="Screenshot of a Table grouped by Date and Order." lightbox="media/basic-table-groups-design.gif":::  
  
 In Preview, the report displays the order data grouped first by date, and then by order, as shown in the following figure.  
  
 :::image type="content" source="media/basic-table-groups-preview.png" alt-text="Screenshot of a Table grouped by date and then order." lightbox="media/basic-table-groups-preview.png":::  
...
### Add totals to row groups  
 ...
 :::image type="content" source="media/basic-table-groups-totals-color-design.gif" alt-text="Screenshot of a Design view, add total rows to group and table." lightbox="media/basic-table-groups-totals-color-design.gif":::  
 ...
 :::image type="content" source="media/basic-table-groups-totals-color-preview-bottom.gif" alt-text="Screenshot of a Preview, Table with Group Totals, last rows." lightbox="media/basic-table-groups-totals-color-preview-bottom.gif":::  
  
 For more information, see [Add a Total to a Group or Tablix Data Region &#40;Power BI Report Builder&#41;](add-total-group-tablix-data-region-report-builder.md).  
  
##  <a name="RemovingHidingRows"></a> Remove or hide detail rows  
 After you preview a table in a report, you might decide to remove existing detail rows. Or you might decide to hide them by default and allow the user to toggle between viewing more or less detail, as in a drilldown report.  
 ...
 :::image type="content" source="media/basic-table-groups-drilldown-no-details-design.gif" alt-text="Screenshot of a Design view, table with two groups, no details." lightbox="media/basic-table-groups-drilldown-no-details-design.gif":::  
...
>  Verify that after you remove a details row, the expression in each cell specifies an aggregate expression where appropriate. If necessary, edit the expression to specify aggregate functions as needed.  
 ...
 :::image type="content" source="media/basic-table-groups-no-details-preview.gif" alt-text="Screenshot of a Preview, table with groups but no detail rows." lightbox="media/basic-table-groups-no-details-preview.gif":::  
 ...
 :::image type="content" source="media/basic-table-groups-drilldown-preview.gif" alt-text="Screenshot of a Preview, table with expanded drilldown node." lightbox="media/basic-table-groups-drilldown-preview.gif":::  
