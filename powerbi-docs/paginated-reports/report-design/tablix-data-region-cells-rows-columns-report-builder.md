---
title: Cells, Rows, & Columns in a Tablix in a Power BI Paginated Report
...
|Icon|Description|  
|----------|-----------------|  
|:::image type="content" source="media/icon-tablix-details-row.gif" alt-text="Screenshot of a Row handle with 3 parallel lines for details row." lightbox="media/icon-tablix-details-row.gif":::|Only the details group on the row group hierarchy|  
|:::image type="content" source="media/icon-tablix-group-details.gif" alt-text="Screenshot of a Row handle with details row and one outer group." lightbox="media/icon-tablix-group-details.gif":::|One outer group and the child details group|  
|:::image type="content" source="media/icon-tablix-nested-group-no-details.gif" alt-text="Screenshot of a Two parallel brackets showing nested groups." lightbox="media/icon-tablix-nested-group-no-details.gif":::|One outer group, one inner group; no details group|  
|:::image type="content" source="media/icon-tablix-nested-group-details.gif" alt-text="Screenshot of a 2 brackets & 3 stacked lines for nested & details." lightbox="media/icon-tablix-nested-group-details.gif":::|One outer group, one inner group, and the child details group|  
|:::image type="content" source="media/icon-tablix-nested-group-parent-footer.gif" alt-text="Screenshot of a One outer group with footer row, one inner group." lightbox="media/icon-tablix-nested-group-parent-footer.gif":::|One outer group with a footer row for totals and one inner group|  
|:::image type="content" source="media/icon-tablix-nested-group-details-totals.gif" alt-text="Screenshot of an outer group bracket, inner group bracket, details." lightbox="media/icon-tablix-nested-group-details-totals.gif":::|One outer group with a footer row for totals, one inner group with a footer row for totals, and one details row|  
|:::image type="content" source="media/icon-tablix-nested-group-parent-header-footer.gif" alt-text="Screenshot of a parent header and footer, and also child group." lightbox="media/icon-tablix-nested-group-parent-header-footer.gif":::|One outer group with a header for labels and a footer for totals, and an inner group; no details group|  
...
-   Group indicators that show all group memberships for a selected cell.  
 ...
 :::image type="content" source="media/tablix-row-group-visual-cues.gif" alt-text="Screenshot of a Table with detail and nested row groups." lightbox="media/tablix-row-group-visual-cues.gif":::  
...
### Total rows  
 ...
 :::image type="content" source="media/tablix-parts.gif" alt-text="Screenshot of a Tablix data region." lightbox="media/tablix-parts.gif":::  
...
### Grouping pane  
 ...
 :::image type="content" source="media/basic-tablix-design-grouping-pane-default-view.gif" alt-text="Screenshot of a Grouping pane for nested row and column groups." lightbox="media/basic-tablix-design-grouping-pane-default-view.gif":::  
