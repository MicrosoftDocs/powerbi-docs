...
In Power BI, you can publish *apps* with collections of related dashboards and reports. You create apps in *app workspaces*, where you can collaborate on Power BI content with your colleagues. Then you can publish the finished apps to large groups of people in your organization. Power BI is previewing a new workspace experience. This article describes how creating apps has changed in the new app workspaces. Read about [the new workspaces (preview)](service-create-the-new-workspaces.md).
