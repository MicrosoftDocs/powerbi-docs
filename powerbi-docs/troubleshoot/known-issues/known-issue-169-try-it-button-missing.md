...
In the past, you were able to try Power BI REST APIs on each operations page linked from the [Admin Overview page](../admin).   Under **Examples**, you would see **Sample Request** code sections with a "Try it" button on the header to test the API.
