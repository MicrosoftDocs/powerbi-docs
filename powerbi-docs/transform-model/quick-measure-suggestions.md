...
:::image type="content" source="media/quick-measure-suggestions/dax-measure-suggestion.png" alt-text="Example of a DAX measure suggestion":::
...
:::image type="content" source="media/quick-measure-suggestions/enable-preview.png" alt-text="Enable preview":::
...
:::image type="content" source="media/quick-measure-suggestions/suggestions-tab.png" alt-text="How to access the feature from the suggestions tab of the Quick measure pane":::
...
:::image type="content" source="media/quick-measure-suggestions/quick-measure-suggestions-admin-setting.png" alt-text="Admin setting for measure suggestions":::
