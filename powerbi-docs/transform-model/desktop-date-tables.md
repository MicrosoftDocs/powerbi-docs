...
For more information about this automatic behavior, see [Auto date/time in Power BI Desktop](desktop-auto-date-time.md).
...
2. On the **Column tools** tab, select **Data type** and then choose the drop-down arrow to show available data types.
