...
:::image type="content" source="media/desktop-loganalytics-reportguide-datasets/template-app-as-engine-flow.png" alt-text="Screenshot of a diagram showing the major pages of the Template app and some important available drillthroughs.":::
...
:::image type="content" source="media/desktop-loganalytics-reportguide-datasets/nav-bar.png" alt-text="Screenshot of the navigation bar for the Template app.":::
...
:::image type="content" source="media/desktop-loganalytics-reportguide-datasets/filters.png" alt-text="Screenshot highlighting the filter button at the top of the page on the Template app.":::
...
:::image type="content" source="media/desktop-loganalytics-reportguide-datasets/workspace-summary.png" alt-text="Screenshot of the Workspace summary page in the Template app.":::
...
:::image type="content" source="media/desktop-loganalytics-reportguide-datasets/dataset-refreshes.png" alt-text="Screenshot of the Dataset refreshes page in the Template app.":::
...
:::image type="content" source="media/desktop-loganalytics-reportguide-datasets/query-statistics.png" alt-text="Screenshot of the Query statistics page in the Template app.":::
...
:::image type="content" source="media/desktop-loganalytics-reportguide-datasets/error-summary.png" alt-text="Screenshot of the Error summary page in the Template app.":::
...
:::image type="content" source="media/desktop-loganalytics-reportguide-datasets/help.png" alt-text="Screenshot of the Help page that's in the Template app.":::
...
* [Configure Azure Log Analytics for Power BI (Preview)](desktop-log-analytics-configure.md)
