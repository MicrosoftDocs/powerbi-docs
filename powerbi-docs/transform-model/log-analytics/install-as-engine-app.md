...
1. Go to [AppSource > Power BI Log Analytics for Analysis Services Engine](https://appsource.microsoft.com/en-us/product/power-bi/pbi_pcmm.powerbiloganalyticsforasengine) and select **Get it now**.
