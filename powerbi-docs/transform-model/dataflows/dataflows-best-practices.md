...
|Linked tables      |Reusing and referencing transformations         |[Linked Tables](/power-bi/transform-model/dataflows/dataflows-create#create-a-dataflow-using-linked-tables)         |
