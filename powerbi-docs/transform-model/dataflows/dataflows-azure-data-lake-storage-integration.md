...
- The ADLS Gen 2 account must be deployed in the [same region as your Power BI tenant](https://docs.microsoft.com/en-us/power-bi/admin/service-admin-where-is-my-tenant-located). An error occurs if the locations of the resources are not in the same region.
