---
title: Connect to AI Insights in Power BI Desktop (Deprecating)
...
* Incremental refresh is supported but can cause performance issues when used on queries with AI insights.
* Direct Query isn't supported.
* Users with a Premium Per User (PPU) only license can't use AI Insights from Power BI Desktop; you must use a non-PPU Premium license with its corresponding Premium capacity. You can still use AI Insights with a PPU license the Power BI service.
