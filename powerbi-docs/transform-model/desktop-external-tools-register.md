...
:::image type="content" source="media/desktop-external-tools-register/json-example-output.png" border="false" alt-text="PowerShell console output":::

## Icon data URIs

To include an icon in the External Tools ribbon, the pbitool.json registration file must include an iconData element.

:::image type="content" source="media/desktop-external-tools-register/tool-ribbon.png" alt-text="External tools ribbon with tool icons":::
