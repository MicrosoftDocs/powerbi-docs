...
Learn more about how to access to Fabric Copilot for Power BI on your tenant in the [Copilot requirements](/create-reports/copilot-introduction#copilot-requirements) section of the Copilot introduction article.
