...
![Screenshot of Power B I Desktop showing Report view selected.](media/desktop-query-overview/queryoverview_viewicons.png)
...
![Screenshot of Power B I Desktop showing Power Query Editor with no data connections.](media/desktop-query-overview/queryoverview_blankpane.png)
...
![Screenshot of Power B I Desktop showing Add Column tab.](media/desktop-query-overview/queryoverview_addcolumnribbon.png)
...
![Screenshot of Power B I Desktop showing View tab.](media/desktop-query-overview/queryoverview_viewribbon.png)
...
![Screenshot of Power B I Desktop showing Queries in left pane.](media/desktop-query-overview/queryoverview_theleftpane.png)
...
![Screenshot of Power B I Desktop showing Data in center pane.](media/desktop-query-overview/queryoverview_thecenterpane.png)
...
![Screenshot of Power B I Desktop showing Query Settings in right pane.](media/desktop-query-overview/queryoverview_querysettingspane.png)
...
![Screenshot of Power B I Desktop showing Query Settings Properties and Applied Steps filters.](media/desktop-query-overview/queryoverview_querysettings_rename.png)
...
![Screenshot of Power B I Desktop showing Advanced Editor dialog box.](media/desktop-query-overview/queryoverview_advancededitor.png)
...
![Screenshot of Power B I Desktop showing Close and Apply option under File tab.](media/desktop-query-overview/queryoverview_closenload.png)

As progress is made, Power BI Desktop provides a dialog to display its status.  
![Screenshot of Power B I Desktop showing Applied Query Changes confirmation dialog box.](media/desktop-query-overview/queryoverview_loading.png)
...
![Screenshot of Power B I Desktop showing Power Query Editor File tab.](media/desktop-query-overview/queryoverview_savework.png)
