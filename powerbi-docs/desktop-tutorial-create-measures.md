...
1.  Right-click the **Sales** table in the Fields well, or hover over the table and select the **More options** **More options** (...), and then select **New Measure**. This will save your new measure in the Sales table, where it will be easier to find.
