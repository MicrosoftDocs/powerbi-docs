...
If you downloaded Power BI Desktop from Microsoft Store, you might be unable to connect to Oracle databases because of an Oracle driver issue. If you encounter this issue, the error message returned is *Object reference not set*. To address the issue, do one of these steps:

* Download Power BI Desktop from https://powerbi.microsoft.com/desktop instead of the Microsoft Store.
