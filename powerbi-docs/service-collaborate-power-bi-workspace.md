...
> [!NOTE]
> The new workspace experience will change the relationship between Power BI workspaces and Office 365 groups. When you create one of the new workspaces in Power BI, you no longer need to create an Office 365 group. For more information, see [creating the new workspaces](service-create-the-new-workspaces.md).
