...
> [!NOTE]
> The new workspace experience changes the relationship between Power BI workspaces and Office 365 groups. When you create one of the new workspaces in Power BI, you no longer need to create an Office 365 group. For more information, see [creating the new workspaces](service-create-the-new-workspaces.md).
...
After you create a Power BI Desktop file, you can publish it to your Power BI app workspace so that everyone in your workspace can collaborate on it.

1. In Power BI Desktop, select **Publish** on the **Home** ribbon, then select your app workspace in the **Select a destination** box.
...
1. Select the ellipsis (...) next to your app workspace name \> **Calendar**. 
   ...
   The calendar for your app's group workspace opens in Outlook for Office 365.
...
If you’re an owner or an administrator for an app workspace, you can also add or remove workspace members. Read more about [managing your Power BI app workspace](service-manage-app-workspace-in-power-bi-and-office-365.md).
