...
* Setting a label via the setLabels API doesn't trigger [downstream inheritance](/fabric/governance/service-security-sensitivity-label-downstream-inheritance) to downstream items.
