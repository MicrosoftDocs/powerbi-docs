...
When private link connection is used, connections will go through the Microsoft private network backbone when Power BI users access resources in the Power BI service.
