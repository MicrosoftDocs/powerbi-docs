...
- Automatic aggregations are only available for models using enhanced metadata. If you want to enable automatic aggregations for an older model, upgrade the model to enhanced metadata first. To learn more, see [Using enhanced model metadata](../connect-data/desktop-enhanced-model-metadata.md).
