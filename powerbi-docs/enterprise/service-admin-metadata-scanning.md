...
For an extensive list of the artifact and subartifact metadata that metadata scanning returns, see the [WorkspaceInfo GetScanResult API](/rest/api/power-bi/admin/workspace-info-get-scan-result).
