...
## Disable Power BI Dataset Scale-Out

To disable Power BI Dataset Scale-Out, set `QueryScaleOut` to zero. For more information, see the code snippet in [Enable Dataset Scale-Out](#enable-query-scale-out), step 5.
