...
| PublicApiExport | A Power BI report exported with the [Export paginated report to file](../developer/embedded/export-paginated-report.md) REST API | Report | Background |
