...
* Snapshots are not deleted automatically on ADLS Gen 2. if you wish to free up space you can create an Azure function to periodically clean up old snapshots.
