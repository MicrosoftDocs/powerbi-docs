...
Dynamic per recipient subscriptions are available for paginated reports and for regular reports.  This article pertains to paginated reports. 
To learn about dynamic subscriptions for regular report, see [Dynamic per recipient subscriptions for reports](power-bi-dynamic-report-subscriptions.md)
