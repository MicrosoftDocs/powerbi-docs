...
Before you use Power Automate to export Power BI Reports, see [Export reports from Power BI to PDF](../end-user-pdf?tabs=powerbi-service#considerations-and-limitations) for PDF and [Export your Power BI report to PowerPoint](/end-user-powerpoint#export-your-power-bi-report-to-powerpoint).
