...
> [!Note]
> For Power BI National Cloud tenants, there is no free license. So, all users who want access to the embedded report in Sharepoint need to have a pro license.
