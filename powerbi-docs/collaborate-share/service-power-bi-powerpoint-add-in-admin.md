...
The Power BI add-in for PowerPoint is supported in national/regional clouds as an admin managed add-in only. While almost all the functionality available in public clouds is also available in national/regional clouds, there are a few differences. See [Deploying the add-in in national/regional clouds](./service-power-bi-powerpoint-add-in-national-clouds.md) for detail.

## Next Steps

* [About storytelling with Power BI in PowerPoint](./service-power-bi-powerpoint-add-in-about.md)
* [Deploying the add-in in national/regional clouds](./service-power-bi-powerpoint-add-in-national-clouds.md)
