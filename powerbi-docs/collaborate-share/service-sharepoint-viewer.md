...
OneDrive and SharePoint events are audited in the Microsoft 365 audit logs. These events include:
- Copy
- Download
- Move to
- Share
...
Interaction with the Power BI file is audited in Power BI activity logs. These events include:
- View
- Open report
