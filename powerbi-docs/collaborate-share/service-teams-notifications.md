...
We recommend that Power BI admins allow notifications in Teams by enabling the [Microsoft Teams integration tenant setting in the Power BI service](../admin/service-admin-portal-export-sharing.md#microsoft-teams-integration-in-the-power-bi-service). When **Enable Microsoft Teams integration in the Power BI service** is disabled, users can no longer receive notifications in Teams.
