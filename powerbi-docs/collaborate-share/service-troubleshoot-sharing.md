...
If you see a "Request access" message when you select the link to a report or dashboard, you do not have permission to view it. You need to [request access to it](service-request-access.md).
