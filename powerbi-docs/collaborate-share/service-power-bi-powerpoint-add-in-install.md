...
1. Check the **Include my changes** box if you want to share the report pages current state, and then select **PowerPoint**.
    ...
    > [!NOTE]
    > The **Open in PowerPoint** option is not available in national/regional clouds. Choose **Copy link** instead and then [paste the link into the Power BI PowerPoint add-in](#paste-the-url-of-a-report-or-visual-into-the-add-in).
...
> [!NOTE]
> Getting the URL through the Export option is not available in national/regional clouds.
