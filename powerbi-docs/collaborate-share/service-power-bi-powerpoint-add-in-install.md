...
1. The add-in will be added to the slide. Paste the report page URL into the text box and then click **Insert**. The report will load into the add-in.
   
    The image below illustrates installing the add-in and pasting the report URL into the text box. It shows how you can resize the add-in and move it around as necessary. 
