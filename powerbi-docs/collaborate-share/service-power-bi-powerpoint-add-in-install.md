...
1. Open PowerPoint and navigate to the slide where you want to insert the report and select the Power BI add-in.
    ...
    ![Screenshot of selecting the Power B I report add-in.](media/service-power-bi-powerpoint-add-in-install/select-power-bi-report-addin.png)
...
![Screenshot of embedded Power B I report page in PowerPoint, with controls labeled.](media/service-power-bi-powerpoint-add-in-install/embedded-report-page-controls1.png)
