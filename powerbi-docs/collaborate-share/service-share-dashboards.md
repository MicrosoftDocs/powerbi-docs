...
- If a user tries to access a report using a link that they do not have access to, they can only access the report if there is another link granting them access or they have direct access to the report.    
