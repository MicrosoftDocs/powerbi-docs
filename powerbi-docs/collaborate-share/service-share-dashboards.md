...
* You can’t use Microsoft 365 Unified groups for direct sharing. If you don’t want to specify individuals, you can use email enabled distribution groups or security groups to share with multiple users.
