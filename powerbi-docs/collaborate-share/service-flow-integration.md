...
2. Select **Create** > **Automated flow**.
    ...
    :::image type="content" source="media/service-flow-integration/power-automate-create-automated-flow.png" alt-text="Screenshot of the Power Automate > Create Automated flow screen.":::   
