...
- The Microsoft 365 group for your classic workspace isn't affected by the workspace upgrade in Power BI. Any Teams, SharePoint sites, mailboxes, or other resources managed by Microsoft 365 aren't changed. They remain intact after you upgrade your Power BI workspace. The Microsoft 365 group continues to exist as before. Upgraded workspace can be deleted if needed. Once upgraded, workspaces are not directly associated with a Microsoft 365 group.
