...
- The option to provide access to the report/dashboard will always show enabled when you edit an existing subscription.  If you uncheck this option and save the subscription, it will save this state, even though when you go to edit the report again it will be checked by default.
