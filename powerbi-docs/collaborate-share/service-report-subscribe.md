...
- For report email subscriptions, if the dataset uses RLS, you can create subscriptions for yourself. You may also subscribe others to a report with row-level security (RLS), those subscriptions will be generated using your security context. Read more about [subscribing to paginated reports](../consumer/paginated-reports-subscriptions.md).
