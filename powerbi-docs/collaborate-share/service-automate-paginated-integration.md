...
:::image type="content" source="media/service-automate-paginated-integration/Power-automate-export-paginated.png" alt-text="Screenshot of the Power Automate flow for exporting a paginated report":::
