...
>
> :::image type="content" source="media/end-user-powerpoint/power-bi-copy.png" alt-text="Screenshot of the Copy as image icon.":::
...
:::image type="content" source="media/end-user-powerpoint/power-bi-powerpoint-numbered.png" alt-text="Screenshot of PowerPoint file opened with numbered elements highlighting key features.":::
...
1. Your published report is rendered in the language according to your Power BI settings, or otherwise by the locale setting of your browser. To see or set your language preference in your browser, select the cog icon :::image type="icon" source="media/end-user-powerpoint/power-bi-settings-icon.png" border="false"::: > **Settings** > **General** > **Language**. For locale information, see [Supported languages and countries/regions for Power BI](../fundamentals/supported-languages-countries-regions.md).
...
:::image type="content" source="media/end-user-powerpoint/power-bi-images.png" alt-text="Screenshot of PowerPoint slide showing each visual as a separate image.":::
...
- Visio visuals
- Visuals [displayed as a Data point table or displayed with "Show data point as a table"](../explore-reports/end-user-show-data.md) can't export to PowerPoint
...
- Visuals [displayed as a Data table or displayed with "Show as a table"](../explore-reports/end-user-show-data.md) export the visual in its default state, without the table.
