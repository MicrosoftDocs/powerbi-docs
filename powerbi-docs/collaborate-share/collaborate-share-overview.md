---
title: "Collaborate and Share Power BI Content"
description: "Discover the many ways to collaborate and share Power BI content across Teams, SharePoint, PowerPoint, and Excel. Start sharing insights today."
author: JulCsc
...
# Collaborate and share Power BI content

Power BI integrates with the Microsoft 365 tools your organization already uses, so you can share insights and collaborate on data without leaving your workflow. This article describes the main ways to share and collaborate in Power BI and links to more detailed articles for each area.

## Share, publish, and endorse your work

Share individual reports and dashboards directly with colleagues, publish apps to distribute polished content at scale, and endorse semantic models and reports so others can trust and discover them.

- [Share reports and dashboards](service-share-dashboards.md)
- [Publish apps from workspaces](service-create-distribute-apps.md)
- [Content endorsement overview](service-endorsement-overview.md)

## Collaborate in workspaces

Workspaces are shared environments where teams can create, organize, and manage Power BI content together. Assign roles to control who can view, edit, or publish content.

- [Workspaces in Power BI](service-new-workspaces.md)
- [Create a workspace](service-create-the-new-workspaces.md)
...
Share Power BI semantic models with guest users in external organizations by using in-place semantic model sharing. Partners can analyze your data in their own tenant.

- [About in-place semantic model sharing](service-dataset-external-org-share-about.md)
- [Share semantic models with external users](service-dataset-external-org-share-provider.md)

## Power BI in Outlook and Microsoft 365
