...
> [!NOTE]
> On December 31st, 2024, the **Teams activity analytics** report feature will be retired. As of January 1st, 2025, users will no longer be able to create reports generated by this feature, and existing reports generated by this feature will no longer be updated. Instead of the Teams activity analytics report, users are encouraged to use the native analytics view for teams and channels provided by Teams itself. For information about this view, see [View analytics for your teams in Microsoft Teams]().

For more information about the retirement of the Teams activity analytics report feature and how this might affect you, see [Power BI in Teams – Announcing the retirement of the Teams activity analytics report]().
