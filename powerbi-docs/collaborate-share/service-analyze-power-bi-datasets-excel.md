...
:::image type="content" source="media/service-analyze-power-bi-datasets-excel/analyze-powerbi-datasets-excel-pivottable.png" alt-text="1Screenshot that shows a blank PivotTable for analysis in Excel.":::
