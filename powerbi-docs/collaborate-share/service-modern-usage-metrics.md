...
- Sharing is disabled for the usage metrics report. To give people read access to the report, you can open the report and use the "Manage permissions" option to grant direct access.
