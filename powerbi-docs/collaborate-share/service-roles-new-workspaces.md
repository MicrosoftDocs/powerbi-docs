...
| Feature apps on colleagues' home. <sup>6</sup> |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Supported." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Supported." border="false":::  |   |   |
...
<sup>6</sup> If your admin has enabled this feature, see [Manage featured content](https://learn.microsoft.com/en-us/fabric/admin/service-admin-portal-featured-content)

<sup>7</sup> If your admin has enabled this feature. see [Users can try Microsoft Fabric paid features](https://learn.microsoft.com/en-us/fabric/admin/service-admin-portal-help-support#users-can-try-microsoft-fabric-paid-features)
