...
| Schedule data refreshes via Shared Cloud connections | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Supported." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Supported." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Supported." border="false"::: |  | You also need permissions to the Shared Cloud connection. Those permissions are managed elsewhere, independent of workspace roles and permissions. See [Connect to cloud data sources in the Power BI service](/connect-data/service-connect-cloud-data-sources). |
