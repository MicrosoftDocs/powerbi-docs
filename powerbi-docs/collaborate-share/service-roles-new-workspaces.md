...
| Create a report in another workspace based on a dataset in this workspace.<sup>2</sup> |  ![Yes checkmark](media/service-roles-new-workspaces/green-checkmark.png) | ![Yes checkmark](media/service-roles-new-workspaces/green-checkmark.png)  | ![Yes checkmark](media/service-roles-new-workspaces/green-checkmark.png)  |   |
