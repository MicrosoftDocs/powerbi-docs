...
|---|---|---|---|---|
| Update and delete the workspace.  | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: |   |   |   | 
| Add or remove people, including other admins.  |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: |   |   |   |
| Allow Contributors to update the app for the workspace.  |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: |   |   |   |
| Add members or others with lower permissions.  |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  |   |   |
| Publish, unpublish, and change permissions for an app. |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  |   |   |
| Update an app. |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  |  If allowed <sup>1</sup>  |   |
| Share an item or share an app.<sup>2</sup> |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  |   |   |
| Allow others to reshare items.<sup>2</sup> |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  |   |   |
| Feature apps on colleagues' home. |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  |   |   |
| Manage dataset permissions.<sup>3</sup> | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: |  |  |
| Feature dashboards and reports on colleagues' home. |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: |   |
| Create, edit, and delete content, such as reports, in the workspace.  |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  |   |
| Publish reports to the workspace, and delete content.  |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  |   |
| Create a report in another workspace based on a dataset in this workspace.<sup>3</sup> |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  |   |
| Copy a report.<sup>3</sup> | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: |  |
| Create metrics that's based on a dataset in the workspace.<sup>3</sup> | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: |  |
| Schedule data refreshes via the on-premises gateway.<sup>4</sup> | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: |  |
| Modify gateway connection settings.<sup>4</sup> | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: |  |
| View and interact with an item.<sup>5</sup> |  :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false":::  |
| Read data that's stored in workspace dataflows. | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: | :::image type="content" source="../includes/media/yes-icon.png" alt-text="Yes checkmark." border="false"::: |
