...
- If you're looking for a custom access request or an automated custom message, it's not supported in reports; however, it is supported in [Power BI apps](../collaborate-share/service-create-distribute-apps.md#customize-the-access-request-behavior).
