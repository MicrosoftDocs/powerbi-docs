...
1. Create [measures in your data model in **Power BI Desktop**](../transform-mod../transform-model/desktop-tutorial-create-measures.md), then publish the data model to the **Power BI service** and access that published dataset from Excel.
...
[Tutorial: Create your own measures in Power BI Desktop](../transform-mod../transform-model/desktop-tutorial-create-measures.md)
