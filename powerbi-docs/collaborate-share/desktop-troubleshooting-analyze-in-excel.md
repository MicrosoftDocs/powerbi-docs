...
![Screenshot of Analyze in Excel updates dialog showing the Download(preview) button.](media/desktop-troubleshooting-analyze-in-excel/tshoot-analyze-excel_2.png)
...
![Screenshot of dialog that appears during installation of Excel O L E D B provider client libraries to confirm an upgrade](media/desktop-troubleshooting-analyze-in-excel/troubleshoot-analyze-excel_2.png)
