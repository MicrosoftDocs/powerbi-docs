---
title: Enhance Storytelling in PowerPoint Presentations with the Power BI Add-in
...
# Enhance storytelling in PowerPoint presentations with the Power BI add-in
...
- You must have access to the Office add-in store, or the add-in must be available to you as an [admin-managed add-in](/microsoft-365/admin/manage/centralized-deployment-of-add-ins).
...
- You must have an active Power BI account and a Fabric Free license, as well as access to the data.
- If the Power BI report isn't located in a Premium capacity or Fabric F64 or greater capacity, a Power BI Pro license is needed.
