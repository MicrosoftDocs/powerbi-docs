...
* To access lineage view, go to the workspace list view. Tap the arrow next to **View** and select **Lineage**.
    ...
    :::image type="content" source="media/service-data-lineage/service-data-lineage-view-select.png" alt-text="Screenshot showing the lineage option in the View dropdown menu."
:::
...
:::image type="content" source="media/service-data-lineage/service-data-lineage-data-source-card.png" alt-text="Screenshot showing the lineage view data source with no gateway."
:::
...
:::image type="content" source="media/service-data-lineage/service-data-lineage-data-gateway-card.png" alt-text="Screenshot showing the lineage view data source with a gateway."
:::
...
:::image type="content" source="media/service-data-lineage/service-data-lineage-promoted-certified.png" alt-text="Screenshot showing certified semantic models in lineage view."
:::
...
:::image type="content" source="media/service-data-lineage/service-data-lineage-side-pane.png" alt-text="Screenshot showing the side pane with more information."
:::
...
* Select the double arrows under the artifact.
    ...
    :::image type="content" source="media/service-data-lineage/service-data-lineage-specific-artifact.png" alt-text="Screenshot showing highlighted lineage for a specific artifact."
:::
...
* To have more room for the graph itself, use the full screen option at the bottom-right corner. 
    ...
    :::image type="content" source="media/service-data-lineage/service-data-lineage-zoom.png" alt-text="Screenshot showing zoom in or out, or full screen options."
:::
