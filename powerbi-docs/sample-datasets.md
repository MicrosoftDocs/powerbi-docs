...
### Customer Profitability sample  ![](media/sample-datasets/power-bi-cp2.png)
...
1. Download the files individually using the links below.
   ...
   * [Supplier Quality Analysis Sample](http://download.microsoft.com/download/8/C/6/8C661638-C102-4C04-992E-9EA56A5D319B/Supplier%20Quality%20Analysis%20Sample%20PBIX.pbix)
   ...
   * [Opportunity Tracking Sample](http://download.microsoft.com/download/9/1/5/915ABCFA-7125-4D85-A7BD-05645BD95BD8/Opportunity%20Analysis%20Sample%20PBIX.pbix)
...
2. From Desktop, select **File > Open** and navigate to the location where you saved the sample .pbix.
