...
| ![Item 10](../media/legend-number/legend-number-10-fabric.svg) | Some, or all, reports and dashboards are published as a [Power BI app](../explore-reports/end-user-apps.md). The purpose of the app is to provide a set of related content for consumers to view in a user-friendly way. |
...
| ![Item 13.](../media/legend-number/legend-number-13-fabric.svg) | Users who frequently work in Microsoft Teams might find it convenient to manage or [view Power BI content directly in Teams](../collaborate-share/office-integration/service-collaborate-microsoft-teams.md). |
