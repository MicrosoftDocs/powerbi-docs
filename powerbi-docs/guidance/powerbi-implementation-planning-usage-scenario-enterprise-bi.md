...
:::image type="content" source="media/powerbi-implementation-planning-usage-scenario-enterprise-bi/usage-scenario-enterprise-bi.png" alt-text="Image shows a diagram of enterprise B I, which is organization-wide content distribution at scale. Items in the diagram are described in the table below." lightbox="media/powerbi-implementation-planning-usage-scenario-enterprise-bi/usage-scenario-enterprise-bi-expanded.png" border="false":::
...
| ![Item 7.](media/common/icon-07-red-30x30.png) | When ready, the report creator publishes the Power BI Report Builder file (.rdl) to the Power BI service. |
...
| ![Item 9.](media/common/icon-09-red-30x30.png) | In this enterprise BI scenario, use of [Premium capacity](../admin/service-premium-what-is.md) (rather than Premium Per User) is depicted. This choice is made to support content delivery to many content viewers who have a free Power BI license. |
