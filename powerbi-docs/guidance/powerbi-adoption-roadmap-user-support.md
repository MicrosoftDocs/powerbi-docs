...
>
> - Be sure to cultivate multiple experts in the more difficult topics like [Data Analysis eXpressions (DAX)](/power-bi/transform-model/desktop-quickstart-learn-dax-basics) and the [Power Query M formula language](/powerquery-m/quick-tour-of-the-power-query-m-formula-language). When a community member becomes a recognized expert, they could become overburdened with too many requests for help.
...
It's very common to see people posting Power BI technical questions on social media platforms. You might find discussions, post announcements, and users helping each other.
...
> - **Set up automation:** Ensure that all your Free, Power BI Pro, and Premium Per User (PPU) licensed users automatically have access to the community discussion channel. It's possible to automate license setup by using [group-based licensing](/azure/active-directory/enterprise-users/licensing-groups-assign).
