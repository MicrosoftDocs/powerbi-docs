...
- For more information about DirectQuery, see [Dataset modes in the Power BI service (DirectQuery mode)](../connect-da../connect-da../connect-data/service-dataset-modes-understand.md#directquery-mode).
...
- Especially for large data volumes or a need for low-latency results, convert the design to a DirectQuery or [Composite](../connect-da../connect-da../connect-data/service-dataset-modes-understand.md#composite-mode) model
...
- Especially for smaller data volumes or for non-volatile data, convert the design to an Import or [Composite](../connect-da../connect-da../connect-data/service-dataset-modes-understand.md#composite-mode) model
