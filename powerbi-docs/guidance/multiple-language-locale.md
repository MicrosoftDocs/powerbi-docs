...
The live demo displays the `USERCULTURE` return value in the upper right corner of the report banner. You don't typically display a report element like this in a real application.
