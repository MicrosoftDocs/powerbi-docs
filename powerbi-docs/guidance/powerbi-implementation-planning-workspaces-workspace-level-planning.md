...
Each workspace has a [license mode](/fabric/get-started/workspaces#license-mode) setting. It can be set to **Pro**, **Premium per user (PPU)**, **Fabric capacity**, **Embedded**, or **Trial**. The [type of license](/fabric/enterprise/licenses#microsoft-fabric-license-type) is important for workspace planning because it determines:
