...
- Create a [Live Connection](../connect-da../connect-data/desktop-report-lifecycle-datasets.md) to an already-published model, which could be a Power BI dataset or a remote-hosted Analysis Services model.
...
- [Connect to datasets in the Power BI service from Power BI Desktop](../connect-da../connect-data/desktop-report-lifecycle-datasets.md)
