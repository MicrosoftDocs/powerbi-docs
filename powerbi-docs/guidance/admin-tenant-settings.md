...
The **Export data** setting is enabled by default for the entire organization. It's found in the **Export and sharing settings** group. This setting doesn't affect custom visuals. Downloading from custom visuals is handled by the *Allow downloads from custom visuals* setting.
