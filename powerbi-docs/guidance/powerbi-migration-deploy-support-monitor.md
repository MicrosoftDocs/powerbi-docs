...
- **Create a new Premium capacity:** You may be able to use an existing [Premium capacity](../enterprise/service-premium-gen2-what-is.md). Or, there may be situations when a new Premium capacity is warranted. It could be the case when you purposely wish to separate a departmental workload.
