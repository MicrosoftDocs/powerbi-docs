...
Additional capabilities are available when a workspace is stored on a [Premium capacity](../enterrise/service-premium-what-is.md). Here are several reasons why workspaces on Premium capacity can be advantageous:
