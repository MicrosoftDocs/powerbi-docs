...
Knowing your CTID is important for [Microsoft Entra B2B scenarios](../enterprise/service-admin-azure-ad-b2b.md). URLs that you provide to external users (for example, to view a Power BI report) must append the CTID parameter in order to access the correct tenant.
