...
- **Other reporting tools:** It's not possible to work with auto date/time tables when using [Analyze in Excel](../collaborate-share/service-analyze-in-excel.md), or connecting to the model using non-Power BI report designers.
...
- [Set and use date tables in Power BI Desktop](../transform-mod../transform-model/desktop-date-tables.md)
