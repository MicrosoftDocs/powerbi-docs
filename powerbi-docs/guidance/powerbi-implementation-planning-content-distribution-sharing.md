...
There are other roles that don't directly affect how you share content, but which you use to support content distribution and sharing in certain circumstances.
...
You can also share content via managing permissions to individual content items. For example, if you manage permissions of a semantic model, you can give someone Build permission to connect to and create their own content from that semantic model. When you share a content item via direct access, you are granting certain permissions to that item for user or group.
...
| ![Item 2.](../media/legend-number/legend-number-02-fabric.svg) | Creators can also share items outside the organization. They can distribute content to external guest users who've been added to the organization with Microsoft Entra B2B. Creators can also share reporting items to external users. |
...
The first step when distributing content to consumers is to identify who'll need access to what content. Depending on the number and type of consumers, you'll make different choices about how you distribute content.
...
- [Limitations of Microsoft Entra B2B](../enterprise/service-admin-azure-ad-b2b.md#considerations-and-limitations) prevent you from doing what you need to do. Examples of limitations of Microsoft Entra B2B for consumers include:
  - External guest users may not be able to open files exported from reports that have a sensitivity label with protection settings.
...
- Consume content that's in a workspace which does not use Fabric capacity license mode.
...
- There is no business need for consumers to create their own content.
...
| ![Item 2.](../media/legend-number/legend-number-02-fabric.svg) | Creators can also share items outside the organization. They can distribute content to external guest users who've been added to the organization with Microsoft Entra B2B. In some scenarios, creators can also share their content files to external users. |
...
You should encourage users to use the [OneLake data hub](/fabric/get-started/onelake-data-hub) to discover content that they can use as a data source. There, and when necessary, content creators can request access to these data items. When they are granted Build permission, they can then create new content from these items.
