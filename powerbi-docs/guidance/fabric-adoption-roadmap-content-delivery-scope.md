...
- Plan for how to effectively use [Premium Per User](../enterprise/service-premium-per-user-faq.md) or [Fabric capacity](/fabric/enterprise/licenses) licensing per workspace. Align your workspace management strategy, like how [workspaces](../collaborate-share/service-create-the-new-workspaces.md) will be organized and secured, to the planned [licensing](../enterprise/service-admin-licensing-organization.md) strategy.
