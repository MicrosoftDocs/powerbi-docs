---
title: "Power BI usage scenarios: Self-service data preparation (legacy)"
description: "Learn how Power BI self-service data preparation is about using dataflows (legacy) to centralize data cleansing and transformation work."
...
# Power BI usage scenarios: Self-service data preparation (legacy)
