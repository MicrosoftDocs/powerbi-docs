...
- All relationships are one-to-many, and each relationship is a _strong relationship_. Data integrity issues won't be masked. For more information, see [Model relationships in Power BI Desktop (Relationship evaluation)](../transform-mod../transform-mod../transform-model/desktop-relationships-understand.md#relationship-evaluation).
