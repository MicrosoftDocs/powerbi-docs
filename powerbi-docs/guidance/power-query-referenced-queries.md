...
We recommend you create a [dataflow](../transform-mod../transform-model/service-dataflows-overview.md) instead. Using a dataflow can improve data refresh time, and reduce impact on your data sources.
...
- [Self-service data prep in Power BI](../transform-mod../transform-model/service-dataflows-overview.md)
