...
Reports based on a DirectQuery semantic model ([previously known as a dataset](/power-bi/connect-data/service-datasets-rename)) can be optimized in many ways, as described in the following bulleted list.
