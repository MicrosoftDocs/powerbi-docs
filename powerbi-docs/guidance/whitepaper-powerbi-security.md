...
* Sensitive data, both in the Power BI service and in Power BI Desktop, can be classified and labeled using the same familiar Microsoft Purview Information Protection sensitivity labels used in Office and in Azure Purview.
