...
The Power BI service is governed by the [Microsoft Online Services Terms](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&amp;DocumentTypeId=31) **[link in word doc: https://www.microsoft.com/en-us/licensing/product-licensing/products]**, and the [Microsoft Enterprise Privacy Statement](https://www.microsoft.com/privacystatement/OnlineServices/Default.aspx). For the location of data processing, refer to the Location of Data Processing terms in the [Microsoft Online Services Terms](http://www.microsoftvolumelicensing.com/Downloader.aspx?DocumentId=9555)**[Please confirm if this is the link you want]** and to the [Data Protection Addendum](https://www.microsoftvolumelicensing.com/Downloader.aspx?DocumentId=17880) **[Please confirm if this is the link you want]**. For compliance information, the [Microsoft Trust Center](https://www.microsoft.com/trust-center/product-overview) **[docx has https://www.microsoft.com/trustcenter]** is the primary resource for Power BI. The Power BI team is working hard to bring its customers the latest innovations and productivity. Learn more about compliance in the [Microsoft compliance offerings](/compliance/regulatory/offering-home)**[This link is currently broken]**.
...
Expressions are created by the author of the report with access to the broad range of features of the .Net framework, in lieu of this flexibility, the processing and execution of paginated reports is performed inside a sandbox.

Paginated report definitions (.rdl) are stored in Power BI, and a user needs to authenticate and authorize in the same way as described in the user authentication section.
...
While the private links integration feature provides secure inbound connections to Power BI, the VNet connectivity feature enables secure outbound connectivity from Power BI to data sources within a VNet. 
