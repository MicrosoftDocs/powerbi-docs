...
:::image type="content" source="media/fabric-adoption-roadmap-mentoring-and-user-enablement/center-of-excellence-mentoring.png" alt-text="Diagram shows expertise growing in the business unit as COE involvement decreases over time, which is described below." border="false":::
