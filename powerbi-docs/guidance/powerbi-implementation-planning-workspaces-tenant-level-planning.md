...
| Gateway | &bull;&nbsp;A [data gateway](fabric-adoption-roadmap-system-oversight.md#gateway-architecture-and-management) in standard mode (non-personal) is used. <br/><br/>&bull;&nbsp;All gateway data source credentials use approved credentials. |
