...
Common characteristics of the level 100 maturity level include:
...
Common characteristics of the level 300 maturity level include:
...
Common characteristics of the level 400 maturity level include:

- Business intelligence efforts deliver significant value.
- Power BI hosts critical content throughout the organization.
...
Common characteristics of the level 500 maturity level include:
...
- Adoption of automation adds value, improves productivity, or reduces risk for error.

> [!NOTE]
> The above characteristics are generalized. When considering maturity levels and designing a plan, you'll want to consider each topic or goal independently. In reality, it's probably not possible to reach level 500 maturity level for every aspect of Power BI adoption for the entire organization. So, assess maturity levels independently per goal. That way, you can prioritize efforts where they will deliver most valuable. The remainder of the articles in this Power BI adoption series present maturity levels on a per-topic basis.
...
As a solution progresses to stages 3 or 4, expectations to operationalize the solution are higher.

> [!TIP]
> The importance of scope on expectations for governance is described in the [content delivery scope](powerbi-adoption-roadmap-content-delivery-scope.md) article. That concept is closely related to the topic, but this article approaches it from a different angle. It considers when you alreaydy have a solution that is operationalized and distributed to many users. That doesn't immediately equate to stage 4 solution adoption, as the concept of solution adoption focuses on how much value the content delivers.

### Solution stage 1 – Exploration

Common characteristics of stage 1 solution adoption include:

- Exploration and experimentation are the main approaches to testing out new ideas. It could occur through informal self-service BI, or through a formal proof of concept (POC), which is purposely narrow in scope. It can confirm requirements, validate assumptions, address unknowns, and mitigate risks.
...
### Solution stage 2 – Functional

Common characteristics of stage 2 solution adoption include:
...
- Users are aware of the solution and show interest in using it. Potentially, it may be a limited "preview" release, and so it is not yet be ready to promote to a production [workspace](../collaborate-share/service-create-the-new-workspaces.md).

### Solution stage 3 – Valuable

Common characteristics of stage 3 solution adoption include:
...
- Solution documentation records needs of information consumers (such as data sources used or how metrics are calculated), and also needs of future creators (such as any future maintenance or planned enhancements).
