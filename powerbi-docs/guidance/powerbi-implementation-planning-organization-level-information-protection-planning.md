...
Before getting started with any setup activities, assess what's currently happening within the organization. It's critical to understand the extent to which information protection is currently implemented (or being planned).
...
- **Sensitivity labels not yet in use:** In this case, sensitivity labels aren't used for Microsoft Office files. In this situation, an organization-wide project to implement sensitivity labels will be required. For some organizations this project can represent a significant amount of work, and a considerable time investment. Labels are intended to be used across the organization by various applications (rather than one application, such as Power BI).
...
| **Item** | **Description** |
| --- | --- |
| ![Item 1.](media/common/icon-01-red-30x30.png) | Sensitivity labels are set up in the Microsoft Purview compliance portal. |
| ![Item 2.](media/common/icon-02-red-30x30.png) | Sensitivity labels can be applied to many types of items and files, such as Microsoft Office files, items in the Power BI service, Power BI Desktop files, and emails. |
| ![Item 3.](media/common/icon-03-red-30x30.png) | Sensitivity labels can be applied for Teams sites, SharePoint sites, and Microsoft 365 groups. |
| ![Item 4.](media/common/icon-04-red-30x30.png) | Sensitivity labels can be applied to schematized data assets that are registered in the Microsoft Purview Data Map. |
...
As previously stated, many of the information protection and DLP capabilities that will be set up will have an impact across the entire organization (well beyond Power BI alone). That's why it's critical to assemble a team that includes all the relevant people. The team will be crucial in defining the goals (described in the next section) and guiding the overall effort.

As you're defining roles and responsibilities for your team, we recommend that you include people who can capably translate requirements and communicate well with stakeholders.

Your team may include pertinent stakeholders involving different individuals and groups in the organization:
...
The task of planning and implementing information protection is usually a part-time responsibility for most people. It's typically one of many pressing priorities. Therefore, having an executive sponsor will be helpful to clarify priorities, set deadlines, and provide strategic guidance.
...
> - **Clarify roles and responsibilities:** Make sure everyone involved is clear on their role and what responsibilities they'll have.
...
- **Compliance:** Support compliance efforts for industry, regional, and governmental regulations. A few common regulations include the European Union's General Data Protection Regulation (GDPR), the US Government's Health Insurance Portability and Accountability Act (HIPAA), or the California Consumer Privacy Act (CCPAA). Additionally, your organization may also have internal governance and security requirements that are deemed critical.
- **Auditability and awareness:** Understand where the sensitive data is located throughout the organization and who's using the data.
...
- Access roles, permissions, sharing, and row-level security for Power BI content
...
> [!div class="checklist"]
> - **Identify applicable data privacy regulations and risks:** Ensure that your team is aware of the data privacy regulations your organization is subject to for your industry or geographic region. If necessary, conduct a data privacy risk assessment.
