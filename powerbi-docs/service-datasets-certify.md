...
- **Certification**: Dataset owners can nominate a promoted dataset for certification. A select group of users defined in the **Dataset Certification** tenant admin setting decides which datasets to certify.
...
If your tenant admin names you as someone who can certify datasets, the **Certified** option in the **Endorsement** section of **Settings** is available.
