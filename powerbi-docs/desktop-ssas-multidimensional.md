...
* Only Enterprise and BI editions of SQL Server 2012 and SQL Server 2014 suppor Live connections. For standard version of SQL Server, SQL Server 2016 or later is required for live connections.
