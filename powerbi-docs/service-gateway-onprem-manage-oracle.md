...
For the gateway to be able to connect to your Oracle server, the Oracle Data Provider for .NET (ODP.NET) must be installed and configured. ODP.NET is part of the Oracle Data Access Components (ODAC).
...
After the client is installed, configure your tnsnames.ora file with the proper information for your database. Power BI Desktop and the gateway go off of the net_service_name defined in the tnsnames.ora file. If the file isn't configured, you won't be able to connect. The default path for tnsnames.ora is `[Oracle Home Directory]\Network\Admin\tnsnames.ora`. For more information about how to configure tnsnames.ora files, see [Oracle: Local naming parameters (tnsnames.ora)](https://docs.oracle.com/cd/B28359_01/network.111/b28317/tnsnames.htm).
...
For information about how to add a data source, see [Add a data source](service-gateway-data-sources.md#add-a-data-source). Under **Data Source Type**, select Oracle.
...
> [!NOTE]
> You might also encounter a compatability issue between the Oracle server version and the Oracle client version. Typically, you want these versions to match.
