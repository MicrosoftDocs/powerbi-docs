...
:::image type="content" source="powerbi-docs/admin/media/service-admin-portal-integration/admin-integration-onedrive-viewer.png" alt-text="Users can view Power BI items saved in OneDrive and SharePoint":::
...
:::image type="content" source="powerbi-docs/admin/media/service-admin-portal-integration/admin-integration-power-bi-desktop-share.png" alt-text="Users can share links to Power BI files stored in OneDrive and SharePoint through Power BI Desktop":::
