...
1. Look for the value next to **Your data is stored in**. The location shown is the default region where your data is stored. unless you're using capacities in different regions for your workspaces.
