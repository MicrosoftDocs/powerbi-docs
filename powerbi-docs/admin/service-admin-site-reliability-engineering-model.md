...
Power BI is a global service, and as of June 2021, has more than 7.5 million monthly active users, 76% growth year over year, with an extra 37 million monthly active users of the service's *Publish to Web* capabilities. Power BI is deployed in 52 Azure regions around the world. During times of peak usage, the service executes nearly 20 million queries per hour and ingests over 90 petabytes of data into customer models. These activities are supported by 129 deployed clusters that are powered by more than 350,000 cores.  

Despite absorbing such rapid growth and substantial new capabilities, the Power BI service exhibits strong service reliability and operational excellence. The results shown in the following table are the direct consequence of engineering, tools, and culture changes made by the Power BI team over the past few years, and are highlighted in this article.
...
Through solutions and disciplined operations, the Power BI team has sustained exponential growth and rapid update cycles without increasing overall cost or burden on live site management. The following image shows the continuous and significant decline in Service Reliability Engineering cost per monthly active user (MAU). 

:::image type="content" source="media/service-admin-site-reliability-engineering-model/service-admin-site-reliability-engineering-model-02.png" alt-text="Chart comparing increased customer and associated cost.":::
