...
4. In the **Connect to Premium Capacity Utilization And Metrics** first window, fill in the fields according to the table below:
    ...
    |**Timepoint**  |Yes (auto-populated)  |         |This field is automatically populated and is used for internal purposes. The value in this field will be overwritten when you use the app. |
    |**Timepoint2** |Yes (auto-populated)  |         |This field is automatically populated and is used for internal purposes. The value in this field will be overwritten when you use the app. |
