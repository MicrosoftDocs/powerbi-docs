...
4. In the **Connect to Premium Capacity Utilization And Metrics** first window, fill in the following fields:
    ...
    * **Timepoint** - Enter any value using a valid date time format, for example `10/10/2021 10:00:00 AM`. This field is used for internal purposes and the value you entered will get overwritten.

    * **Timepoint2** - Enter any value using a valid date time format, for example `10/10/2021 10:00:00 AM`. This field is used for internal purposes and the value you entered will get overwritten.
