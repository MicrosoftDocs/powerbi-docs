...
2. In **Create a virtual machine - Basics** enter or select the following information:
    ...
    |Password | Enter a password of your choosing. The password must be at least 12 characters long and meet the [defined complexity requirements](/azure/virtual-machines/windows/faq?toc=%252fazure%252fvirtual-network%252ftoc.json#what-are-the-password-requirements-when-creating-a-vm) |
