...
In the event of an extreme disaster in primary region that prevents bringing it back online for considerable duration, the failed over Power Region will allow both read and write operations and customers will be able to redpepoy and configure gateways against the new region.
