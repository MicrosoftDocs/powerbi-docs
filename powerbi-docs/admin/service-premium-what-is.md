...
>[!NOTE]
>To review the Power BI Embedded Gen2 enhancements, refer to [Power BI Embedded Generation 2](../developer/embedded/power-bi-embedded-gen2.md).
...
> [!NOTE]
> In **Premium Gen2 (preview)** and [Power BI Embedded Generation 2](../developer/embedded/power-bi-embedded-gen2.md), there is no memory management for Paginated reports. With Premium Gen2 and Embedded Gen2, Paginated reports are supported on the EM1-EM3 nad A1-A3 SKUs.
