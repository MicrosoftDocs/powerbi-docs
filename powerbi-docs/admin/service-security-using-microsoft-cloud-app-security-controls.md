...
Custom activity policies are configured in the Cloud App Security portal. [Learn more](/cloud-app-security/user-activity-policies). 
...
A new role is created for Power BI admins when using Cloud App Security with Power BI. When you log in as a Power BI admin to the [Defender for Cloud Apps portal](https://portal.cloudappsecurity.com/), you have limited access to Power-BI-relevant data, alerts, users at risk, activity logs, and other information.
