...
1. Under **R script options**, verify that your local R installation is specified in **Detected R home directories** and that it properly reflects the local R installation you want Power BI Desktop to use. In the following image, the path to the local installation of R is **C:\Program Files\R Open\R-3.4.4\\**.
   ...
   :::image type="content" source="media/desktop-r-visuals/r-visuals-2.png" alt-text="Screenshot of the R script options page with Detected R home directories highlighted.":::
...
1. Select the **R Visual** icon in the **Visualization** pane to add an R visual.
   ...
   :::image type="content" source="media/desktop-r-visuals/r-visuals-3.png" alt-text="Screenshot of the Visualization pane with the R Visual icon highlighted.":::
   
1. In the **Enable script visuals** window that appears, select **Enable**.

   :::image type="content" source="media/desktop-r-visuals/r-visuals-10.png" alt-text="Screenshot of the Enable script visuals dialog with the Enable button highlighted.":::
...
1. When you add an R visual to a report, Power BI Desktop makes the following changes:
   ...
   1. The **R script editor** appears along the bottom of the center pane.
       ...
       :::image type="content" source="media/desktop-r-visuals/r-visuals-4.png" alt-text="Screenshot of the Power BI R script editor.":::
...
The generated dataframe is named **dataset**, and you access selected columns by their respective names. For example, access the `gear` field by adding `dataset$gear` to your R script. For fields with spaces or special characters, use single quotes.
   ...
   - Similar to table visuals, fields are grouped and duplicate rows appear only once.
       ...
       :::image type="content" source="media/desktop-r-visuals/r-visuals-5.png" alt-text="Screenshot of the R script editor with the script code highlighted.":::
...
1. When you select the **Run script** icon, Power BI Desktop identifies the plot and presents it on the canvas. Because the process is executed on your local R installation, make sure the required R packages are installed.
   ...
   :::image type="content" source="media/desktop-r-visuals/r-visuals-6.png" alt-text="Screenshot of the correlation plot code example.":::
...
1. To get a larger view of the visualizations, deselect the R visual or minimize the **R script editor**. Like other visuals in Power BI Desktop, you can cross filter the correlation plot by selecting a specific value, such as Auto or Manual, in the donut chart visual on the right.
    ...
    :::image type="content" source="media/desktop-r-visuals/r-visuals-7.png" alt-text="Screenshot of the correlation plot code example in a larger visualization view.":::
...
```
   ...
   :::image type="content" source="media/desktop-r-visuals/r-visuals-8.png" alt-text="Screenshot of an R visual circle plot example.":::
   ...
   :::image type="content" source="media/desktop-r-visuals/r-visuals-9.png" alt-text="Screenshot of an error message displayed on the canvas.":::
...
- Column renaming: R visuals don't support renaming input columns. Columns are referred to by their original name during script execution.
