...
Authors can also turn on an admin setting to [only show **approved items** in the standalone Copilot experience](/fabric/admin/service-admin-portal-copilot#only-show-approved-items-in-the-standalone-copilot-in-power-bi-experience-preview).
