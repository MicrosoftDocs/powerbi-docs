...
3. To filter your report to a specific state, select the arrow to expand the Filters pane.
    ...
    :::image type="content" source="media/sample-covid-19-us/power-bi-covid-19-filters-pane.png" alt-text="Screenshot of the Filters pane, highlighting the expand arrow.":::

4. Select a state that you're interested in.

    :::image type="content" source="media/sample-covid-19-us/power-bi-covid-19-filter-selection.png" alt-text="Screenshot of the Filters on all pages pane, highlighting an example state.":::
...
2. Select **Anonymous** > **Connect**.
    ...
    :::image type="content" source="media/sample-covid-19-us/power-bi-covid-19-azure-blob.png" alt-text="Screenshot of the Azure Blob Storage window, highlighting Anonymous and Connect.":::

3. Select **Ignore Privacy Levels**, if shown > **Save**.

    :::image type="content" source="media/sample-covid-19-us/power-bi-covid-19-privacy-levels.png" alt-text="Screenshot of the Privacy levels window.":::
...
The refreshed data is loaded each time the schedule runs. The underlying data is provided by USAFacts and might not update as frequently as your refresh schedule. Check the [USAFacts website](https://usafacts.org/visualizations/coronavirus-covid-19-spread-map/) to know when the underlying data was last updated.

If you intend to publish the customized report on your website, it's best to configure your scheduled refresh to run at least as frequently as the USAFacts data updates. Since USAFacts might refresh their data at different times each day, you might want to configure several refreshes each day.
...
2. Enter the following URL:
    ...
    :::image type="content" source="media/sample-covid-19-us/power-bi-covid-19-from-web.png" alt-text="Screenshot of the From Web window with the sample URL entered.":::
...
4. Select **Load** to load the dataset for total confirmed cases worldwide.
    ...
    :::image type="content" source="media/sample-covid-19-us/power-bi-covid-19-load-data.png" alt-text="Screenshot of a Covid 19 dataset to be loaded.":::
...
Data is provided by USAFacts. Because of the frequency of data updates, they might not reflect the exact numbers reported by government organizations or the news media. For more information or to download the data, see the [USAFacts website](https://usafacts.org/visualizations/coronavirus-covid-19-spread-map/).
