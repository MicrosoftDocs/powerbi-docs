...
In Power BI Desktop, use the Copilot chat pane to ask data questions about your semantic model. This feature works with both local models open in Power BI Desktop and when you're connected to a shared semantic model by using a live connection. For more information, see [*Ask data questions*](#ask-data-questions) earlier in this article.
...
In the Power BI mobile app, use the Copilot chat pane in the app to ask data questions for any report. The questions go to the connected semantic model for that report. This feature works similarly to the [*Ask data questions*](#ask-data-questions) experience explained earlier in this article.
