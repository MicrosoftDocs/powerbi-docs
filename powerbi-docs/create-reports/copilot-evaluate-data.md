...
Before you start using Copilot with your semantic model, evaluate your data. You might need to clean up your semantic model so Copilot can derive insights from it.
...
The following table lists other criteria to help you create accurate [DAX queries with Copilot](/dax/dax-copilot). These items are recommendations that can help in generating accurate DAX queries. 
