...
![copilot-button-ribbon.png](media/copilot-pane-summarize-content/copilot-button-ribbon.png)

The Copilot pane opens. 

![copilot-pane-blank.png](media/copilot-pane-summarize-content/copilot-pane.png)
...
![empty-state-prompt-guide.png](media/copilot-pane-summarize-content/empty-state-prompt-guide.png)

After you choose a prompt, select **Enter** and watch Copilot generate your summary.
 
![copilot-summary-1.png](media/copilot-pane-summarize-content/copilot-summary-1.png)
...
![reference-hover-state.png](media/copilot-pane-summarize-content/reference-hover-state.png)
...
![bulleted-insights](media/copilot-pane-summarize-content/bulleted-insights.png)
...
![copilot-question-1.png](media/copilot-pane-summarize-content/copilot-pane.png)
