...
In rare cases, publishing over an unstable network connection can result in duplicate copies of the report appearing in your workspace. To resolve the issue, you can safely remove the duplicates. For best results, publish over a reliable network connection.
