...
* When creating a parameter rule for a dataflow, if you want [auto-binding](deployment-pipelines-process.md#auto-binding) to work, you must create two parameter rules: one for the dataflow's workspace ID, and another that includes the dataflow ID.
