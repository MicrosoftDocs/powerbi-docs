...
The Retail Analysis downloadable sample contains a dashboard, report, and dataset that analyzes retail sales data of items sold across multiple stores and districts. The metrics compare this year's performance to last year's for sales, units, gross margin, and variance, as well as new-store analysis. 
...
This tutorial explores the Retail Analysis downloadable sample in the Power BI service. Because the report experience is similar in Power BI Desktop and in the service, you can also follow along by using the sample .pbix file in Power BI Desktop. 
...
## Get the sample
 ...
 Before you can use the sample, you must first ,download it in the Power BI service](#get-the-content-pack-for-this-sample), or get the [.pbix file](#get-the-pbix-file-for-this-sample) or [Excel workbook](#get-the-excel-workbook-for-this-sample).
...
5. Power BI imports the downloadable sample, and then adds a new dashboard, report, and dataset to your current workspace.
