...
- The Power BI mobile apps support anonymously accessible image URLs only. Images hosted on sites that require sign-in won't display in the mobile apps, even if an embed code is used.
