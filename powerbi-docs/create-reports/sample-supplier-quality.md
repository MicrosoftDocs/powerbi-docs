...
![Screenshot showing the dashboard for the Supplier Quality Analysis sample.](media/sample-supplier-quality/supplier1.png)
...
4. Select **Supplier Quality Analysis Sample**, then choose **Connect**.  
   ...
   ![Screenshot showing the Connect button.](media/sample-supplier-quality/supplier16.png)

5. Power BI imports the built-in sample and then adds a new dashboard, report, and dataset to your current workspace.

   ![Screenshot showing the Supplier Quality Analysis Sample entry.](media/sample-supplier-quality/supplier17.png)
...
1. On the dashboard, select the **Total Defect Quantity** or the **Total Downtime Minutes** tile.
   ...
   ![Screenshot showing the tiles to open the Downtime Analysis page.](media/sample-supplier-quality/supplier2.png)  
...
3. Select the **Corrugate** column to see which plants are affected most by this defect and which vendor is responsible.  
   ...
   ![Screenshot showing the Corrugate column selected.](media/sample-supplier-quality/supplier3.png)  
...
2. Select the **Downtime (min) by Vendor** area chart, and in the **Visualizations** pane, select the **Treemap** icon.  
   ...
   :::image type="content" source="media/sample-supplier-quality/supplier-4.png" alt-text="Screenshot showing the Treemap icon selected.":::
    ...
    ![Screenshot showing the Downtime (min) by Vendor treemap.](media/sample-supplier-quality/supplier5.png)  
...
1. On the dashboard, select the **Total Defect Reports by Plant, Defect Type** map tile.
   ...
   ![Screenshot showing the tile for Total Defect Reports by Plant, Defect Type.](media/sample-supplier-quality/supplier6.png)  
...
2. In the legend of the **Total Defect Reports by Plant and Defect Type**, select the **Impact** circle.  
    ...
    ![Screenshot showing the Total Defect Reports by Plant and Defect Type with the Impact circle selected in the legend.](media/sample-supplier-quality/supplier7.png)  
...
3. Select the **Logistics** bubble in the bubble chart and observe the plants in Springfield and Naperville, IL. Naperville seems to be doing a much better job of managing defective supplies as it has a high number of rejects and few impacts, compared to Springfield's large number for impacts.  
   ...
   ![Screenshot showing the results of selecting the Logistics bubble.](media/sample-supplier-quality/supplier8.png)  
...
1. In the dashboard, look at the **Total Defect Quantity by Material Type, Defect Type** tile.
   ...
   ![Screenshot showing the tile for Total Defect Quantity by Material Type, Defect Type.](media/sample-supplier-quality/supplier9.png)
...
2. In the dashboard, look at the **Total Defect Qty, Total Downtime Minutes by Material Type** tile.
   ...
   ![Screenshot showing the tile for Total Defect Qty, Total Downtime Minutes by Material Type.](media/sample-supplier-quality/supplier10.png)
...
2. In the **Total Defect Qty by Month and Year** chart, notice that defect quantity is higher in 2014 than in 2013.  
    ...
    ![Screenshot showing the Total Defect Qty by Month and Year chart.](media/sample-supplier-quality/supplier11.png)  
...
5. Because we know that raw materials have the highest number of defects, type in the question box: *show material types, year, and total defect qty*.  
    ...
    ![Screenshot showing the Q&A question: Show material types, year, and total defect qty.](media/sample-supplier-quality/supplier12.png)  
6. Next, change the question to: _show material types, year, and total **downtime minutes**_.

   ![Screenshot showing the Q&A question: Show material types, year, and total downtime minutes.](media/sample-supplier-quality/supplier13.png)
...
1. Select **Exit Q&A** in the upper-left corner to return to the dashboard.  
    ...
    ![Screenshot showing the tile for Total Defect Quantity by Month, Year.](media/sample-supplier-quality/supplier14.png)  
...
2. In the question box, type *total downtime minutes by month and year as a line chart*.  
   ...
   ![Screenshot showing the Q&A question: Total downtime minutes by month and year as a line chart.](media/sample-supplier-quality/supplier15.png)
...
3. To pin this chart to your dashboard, select the pin icon ![Screenshot showing the Pin icon.](media/sample-supplier-quality/pin.png) above the question box.  
