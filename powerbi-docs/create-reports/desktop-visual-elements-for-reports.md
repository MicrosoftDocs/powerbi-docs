...
:::image type="content" source="media/desktop-visual-elements-for-reports/visual-elements-for-reports_01.png" alt-text="Screenshot of a sample Power BI Desktop report with enhanced visuals.":::
...
:::image type="content" source="media/desktop-visual-elements-for-reports/visual-elements-for-reports_02.png" alt-text="Screenshot of Power BI Desktop, highlighting the wallpaper area.":::
...
:::image type="content" source="media/desktop-visual-elements-for-reports/visual-elements-for-reports_03.png" alt-text="Screenshot of the Visualizations pane, highlighting the Wallpaper option.":::
...
:::image type="content" source="media/desktop-visual-elements-for-reports/visual-elements-for-reports_04.png" alt-text="Screenshot of the Visualizations pane, highlighting the Canvas background settings for a dotted border with a transparency greater than 50%.":::
...
:::image type="content" source="media/desktop-visual-elements-for-reports/visual-elements-for-reports_05.png" alt-text="Screenshot of a visual, showing the header to the right of the title.":::
...
:::image type="content" source="media/desktop-visual-elements-for-reports/visual-elements-for-reports_07.png" alt-text="Screenshot of a visual, showing the header at the top right of the visual.":::
...
:::image type="content" source="media/desktop-visual-elements-for-reports/visual-elements-for-reports_08.png" alt-text="Screenshot of a visual, showing the header at the bottom of the visual.":::
...
:::image type="content" source="media/desktop-visual-elements-for-reports/visual-elements-for-reports_10.png" alt-text="Screenshot of the settings for a report in the Power BI service.":::
...
:::image type="content" source="media/desktop-visual-elements-for-reports/visual-elements-for-reports_06.png" alt-text="Screenshot of the Options menu, highlighting Report settings and the Use the modern visual header with updated styling options checkbox.":::
