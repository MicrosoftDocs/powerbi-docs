...
- You just need a [Power BI free license](../consumer/end-user-features.md) to add featured questions to a semantic model in My Workspace in the Power BI service.
