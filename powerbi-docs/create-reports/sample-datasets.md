...
description: Built-in samples and apps in the Power BI service, .pbix files, Excel datasets, and SQL Server databases, all to help you explore Power BI functionality.
author: maggiesMSFT
ms.author: maggies
ms.reviewer: 
ms.custom:
