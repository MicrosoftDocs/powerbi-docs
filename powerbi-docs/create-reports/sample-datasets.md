...
1. Save the downloaded file. Where you save the file makes a difference.
    ...
    ![Local](media/sample-datasets/power-bi-local-file2.png) **Local**: If you save your file to a local drive on your computer, you can **Publish to Power BI** from Excel. After you've published it, there's no remaining relationship between your local file and the file in the Power BI service.    
...
1. You can also upload the Excel files to Power BI. Choose one of these options: 
