---
title: Create a Copilot summary in Power BI from the Teams link 
description: Even if you don't have permission to edit a Power BI report, Copilot can still create a summary for you in the Copilot pane from a Teams link.
author: maggiesMSFT
ms.author: maggies
ms.reviewer: cnews
ms.service: powerbi
...
# Create a Copilot summary in Power BI from the Teams link 
...
Time is valuable, and our goal is to help our users become more efficient and quicker in their tasks. Therefore, “Open Copilot summary in Power BI” button was added to Teams Power BI link message box. 

When you receive a Power BI report in a Teams chat, click on the new Copilot summary button, and read the report’s summary and insights to make informed and data-based decision. This button will direct you to the report in the Power BI app within Teams and display the report summary created by Copilot with one click only. 
