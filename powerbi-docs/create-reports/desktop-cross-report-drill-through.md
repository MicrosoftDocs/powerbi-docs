...
> [!NOTE]
> You can't use cross-report drillthrough with individually shared [Shared with me reports](../collaborate-share/service-share-dashboards.md#share-reports). To use cross-report drillthrough, you must access reports in workspaces that you’re a member of.
