...
* If you disable the switch in the tenant settings described in [Control the use of semantic models across workspaces](../create-reports/service-export-to-pbix.md), your users can't download a .pbix file from copied reports or reports created from datasets in the same workspace.
...
* Semantic models enabled for [large models](../enterprise/service-premium-large-models.md) can't be downloaded to a .pbix file.
