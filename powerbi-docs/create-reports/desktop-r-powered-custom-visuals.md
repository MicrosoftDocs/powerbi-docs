...
:::image type="content" source="media/desktop-r-powered-custom-visuals/powerbi-r-powered-custom-viz_1a.png" alt-text="Screenshot of AppSource filtered to Power Platform and Power BI visuals.":::
...
1. Navigate to the Power BI visuals library, found at [https://appsource.microsoft.com](https://appsource.microsoft.com/). Select the **Products** tab, select **Power Platform**, and then select **See all Power Platform apps**.
   ...
   :::image type="content" source="media/desktop-r-powered-custom-visuals/powerbi-r-powered-custom-viz_2a.png" alt-text="Screenshot of AppSource with Power Platform apps selected under Products.":::

1. On the [Power BI visuals](https://appsource.microsoft.com/marketplace/apps?product=power-bi-visuals&page=1) library page, select **Power BI visuals** from the list of add-ins in the left pane.

   :::image type="content" source="media/desktop-r-powered-custom-visuals/powerbi-r-powered-custom-viz_2b.png" alt-text="Screenshot of AppSource with Power BI visuals selected in the left pane.":::

1. Select the **visual** you're interested in using from the gallery, and you're taken to a page that describes the visual. Select the **Get it now** button to download.
   ...
   :::image type="content" source="media/desktop-r-powered-custom-visuals/powerbi-r-powered-custom-viz_3a.png" alt-text="Screenshot showing the Time Series Forecasting Chart Power BI visual in App Source.":::
...
1. Once the visual is downloaded (which is like downloading any file from your browser), go to Power BI, select **More options** (...) in the **Visualizations** pane, and select **Import a visual from a file**.

   :::image type="content" source="media/desktop-r-powered-custom-visuals/power-bi-desktop-r-powered-custom-visuals.png" alt-text="Screenshot showing More options in the Power BI Visualizations pane.":::

1. You're warned about importing a custom visual, as shown in the following image:

   :::image type="content" source="media/desktop-r-powered-custom-visuals/powerbi-r-powered-custom-viz_5.png" alt-text="Screenshot showing the warning when importing a custom visual into Power BI Desktop.":::
1. Navigate to where the visual file was saved, then select the file. **Power BI Desktop** custom visualizations have the .pbiviz extension.

   :::image type="content" source="media/desktop-r-powered-custom-visuals/powerbi-r-powered-custom-viz_6.png" alt-text="Screenshot showing selection of a Power BI custom visualization file for import.":::
1. When you return to Power BI, you can see the new visual type in the **Visualizations** pane.

   :::image type="content" source="media/desktop-r-powered-custom-visuals/power-bi-desktop-r-powered-custom-visual-forecasting.png" alt-text="Screenshot showing the new imported custom visualization in the Power BI Desktop Visualizations pane.":::

1. When you import the new visual (or open a report that contains an R-powered custom visual), **Power BI Desktop** installs the required R packages.

   :::image type="content" source="media/desktop-r-powered-custom-visuals/powerbi-r-powered-custom-viz_8.png" alt-text="Screenshot showing the R packages that have to be installed for the R-powered custom visual.":::

1. From there, you can add data to the visual just as you would any other **Power BI Desktop** visual. When complete, you can see your finished visual on the canvas. In the following visual, the **Forecasting** R-powered visual on the right was used with United Nations (UN) birth rate projections.

    :::image type="content" source="media/desktop-r-powered-custom-visuals/powerbi-r-powered-custom-viz_10.png" alt-text="Screenshot of the R-powered forecasting visual working with birth rate data and projections.":::
...
1. You can also get Power BI visuals from within Power BI Desktop or the Power BI service. Select the ellipsis (the ...) in the **Visualizations** pane, and select **Get more visuals**.
   ...
   :::image type="content" source="media/desktop-r-powered-custom-visuals/power-bi-desktop-get-more-visuals.png" alt-text="Screenshot showing Get more visuals in More options in the Power BI Visualizations pane.":::

1. When you do so, the **Power BI visuals** dialog box appears, where you can scroll through the available Power BI visuals and select what you would like. You can search by name, select a category, or just scroll through the available visuals. When you're ready, just select **Add** to add the custom visual to Power BI.

   :::image type="content" source="media/desktop-r-powered-custom-visuals/power-bi-r-powered-custom-visuals.png" alt-text="Screenshot showing Power BI visuals available when you select Get more visuals.":::
...
1. If your installation of R isn't current, upgrade your R installation, then remove and reinstall the custom visual as described in the previous step.

   Supported R versions are listed in the description of each R-powered custom visual, as shown in the following image.

     :::image type="content" source="media/desktop-r-powered-custom-visuals/powerbi-r-powered-custom-viz_11.png" alt-text="Screenshot showing the supported R versions for a Power BI R-powered custom visual.":::
    > [!NOTE]
...
1. Install R packages manually, using any R console. The steps for this approach follow:
   1. Download the R-powered visual installation script and save that file to a local drive.
   1. From the R console, run the following:
...
1. If the previous steps don't work, try the following:
   1. Use **R Studio** and follow the step outlined in 3.b. above (run the script line from the R console).
   1. If the previous step doesn't work, change **Tools > Global Options > Packages** in **R Studio**, and enable the checkbox for **Use Internet Explorer library/proxy for HTTP**, then repeat step 3.b. from the above steps.
