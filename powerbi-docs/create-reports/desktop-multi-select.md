---
title: Multiselect data elements, data points, and visuals
...
:::image type="content" source="media/desktop-multi-select/multi-select_01.png" alt-text="Screenshot shows a single data point selected.":::

<a name="multi-select-highlighting"></a>

### Multiselect highlighting

With multiselect, you can select more than one data point in your report and highlight the results across the visuals on the page. This is equivalent to an **and** statement or functionality, such as "highlight results for Idaho **and** Virginia". To multiselect data points in visuals, use **Ctrl + Click** to select multiple data points. The following image shows **multiple data points** selected (multiselect).

:::image type="content" source="media/desktop-multi-select/multi-select_02.png" alt-text="Screenshot shows multiple data points selected.":::
...
Select multiple visuals and other report elements by clicking and dragging over the canvas to create a rectangular lasso. All visuals that are entirely encapsulated within the lasso are selected. If you press the Ctrl or Shift key (as you multiselect by Ctrl + clicking individual visuals), further lassoing adds visual selections to the current multiselect.
...
#### Rectangular multiselect with the Ctrl key
...
#### Rectangular multiselect with the Shift key
...
:::image type="content" source="media/desktop-multi-select/power-bi-rectangle-select.png" alt-text="Screenshot shows a line chart with several ranges selected over a bar chart, which reflects the same selections.":::

You can clear your current selection by clicking an empty space on the plot area without pressing a keyboard key.

#### Rectangular multiselect using the keyboard
...
There are a few considerations and limitations for multiselecting data points within a visual:
