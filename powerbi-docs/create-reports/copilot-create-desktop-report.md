...
See the [current limitations](copilot-create-report-service.md#considerations-and-limitations) section in the article "Create report pages with Copilot in the Power BI service."
