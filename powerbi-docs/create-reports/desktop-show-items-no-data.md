...
>[!CAUTION]
>Enabling the option to show items with no data may negatively affect performance, and can cause slow rendering of visuals or time-out of data export.
