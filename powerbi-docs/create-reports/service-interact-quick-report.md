...
Just like in normal Power BI reports, you can cross-highlight visuals. You can modify the filters on an individual visual in the **Filters** pane, but you can't add new filters to visuals or add page-level or report-level filters.
...
After you save this report, it becomes a normal Power BI report. You can share it, package it in an app, subscribe to email updates, or download the .pbix to make further modifications.
