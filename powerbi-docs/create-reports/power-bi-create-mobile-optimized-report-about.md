---
title: Mobile-Optimized Power BI Reports Overview
description: Learn how to create mobile-optimized Power BI reports with mobile layout view, auto-create options, and formatting tools. Discover how to design attractive, easy-to-read report views for phone users.
author: JulCsc
...
:::image type="content" source="media/power-bi-create-mobile-optimized-report-about/power-bi-mobile-optimized-report-portrait-landscape.png" alt-text="Screenshot of how mobile-optimized report pages display on a phone in portrait and landscape orientation.":::

In the Power BI mobile app, reports that have mobile-optimized pages are indicated with a special icon:

:::image type="content" source="media/power-bi-create-mobile-optimized-report-about/power-bi-mobile-optimized-report-optimized-icon.png" alt-text="Screenshot of optimized report icon in the Power BI mobile apps.":::
...
## Mobile-optimized report authoring features
...
## Publish a mobile-optimized Power BI report

If you create your mobile-optimized report in Power BI Desktop, you only need to publish the main report from Desktop to the Power BI service. This action publishes the mobile-optimized version at the same time.

If you create the mobile-optimized report in the Power BI service, just save the report.
