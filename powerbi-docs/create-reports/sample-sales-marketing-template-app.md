...
:::image type="content" source="media/sample-sales-marketing-template-app/power-bi-sales-marketing-app.png" alt-text="Screenshot of Sales & Marketing template app in List view.":::
...
:::image type="content" source="media/sample-datasets/power-bi-app-edit-pencil.png" alt-text="Edit the template app":::
