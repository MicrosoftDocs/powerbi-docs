...
> [!NOTE]
> **Admins need to turn on the tenant setting:** To try it out, admins need to [enable Copilot in Power BI](https://learn.microsoft.com/power-bi/create-reports/copilot-enable-power-bi), and additionally enable the following new tenant setting: Users can access a standalone, cross-item Power BI Copilot experience. To learn more, see [x](https://go.microsoft.com/fwlink/?linkid=2306434).
> 
