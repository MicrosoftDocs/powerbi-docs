...
![Screenshot showing the See details drillthrough button.](media/desktop-drill-through-buttons/power-bi-drill-through-visual-button.png)
...
![Screenshot showing the filtered visual.](media/desktop-drill-through-buttons/power-bi-drill-through-destination.png)
...
:::image type="content" source="media/desktop-drill-through-buttons/power-bi-create-drill-through-button.png" alt-text="Screen shot showing how to set up a drillthrough button.":::
...
![Screenshot showing a disabled autogenerated tooltip.](media/desktop-drill-through-buttons/power-bi-drill-through-tooltip-disabled.png)
...
![Screenshot showing an enabled autogenerated tooltip.](media/desktop-drill-through-buttons/power-bi-drill-through-visual-button.png)
...
![Screenshot showing the passed filter context.](media/desktop-drill-through-buttons/power-bi-cross-filter-drill-through-button.png)
...
![Screenshot showing the listing for Filters on this page.](media/desktop-drill-through-buttons/power-bi-button-filters-passed-through.png)
