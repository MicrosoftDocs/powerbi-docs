...
![Screenshot of a visual, highlighting the See details drillthrough button.](media/desktop-drill-through-buttons/power-bi-drill-through-visual-button.png)
...
![Screenshot of a visual, highlighting a disabled autogenerated tooltip.](media/desktop-drill-through-buttons/power-bi-drill-through-tooltip-disabled.png)
...
![Screenshot of a visual, highlighting an enabled autogenerated tooltip.](media/desktop-drill-through-buttons/power-bi-drill-through-visual-button.png)
...
![Screenshot of a visual, highlighting Word cross-filtered into the Store Breakdown.](media/desktop-drill-through-buttons/power-bi-cross-filter-drill-through-button.png)
...
![Screenshot of the Filters pane, highlighting the applied filters.](media/desktop-drill-through-buttons/power-bi-button-filters-passed-through.png)
...
1. When a single product is selected, the button text reads:
   ...
   ![Screenshot of Category Breakdown, highlighting See details for Word.](media/desktop-drill-through-buttons/power-bi-conditional-button-text.png)

1. When either no products are selected, or more than one product is selected, the button is disabled. The button text reads:

   "See product details"

   ![Screenshot of Category Breakdown, highlighting multiple values selected and the disabled See product details button.](media/desktop-drill-through-buttons/power-bi-button-conditional-text-2.png)
