...
For example, in the following image, the **Alt** keys have been pressed to display KeyTips, which contain the letters for accessible commands. Pressing **M** opens the **Modeling** tab on the ribbon.
