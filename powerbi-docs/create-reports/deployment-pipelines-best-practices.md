...
>[!NOTE]
>If your organization is using [shared centralized datasets](../connect-da../connect-data/service-datasets-share.md), you can skip this recommendation.
...
With [shared datasets](../connect-da../connect-data/service-datasets-share.md), you can also use this method across workspaces.
...
You can separate modeling development from visualizations, by managing a [shared dataset](../connect-da../connect-data/service-datasets-share.md) in an external workspace, using XMLA r/w capabilities. The shared dataset can connect to multiple reports in various workspaces that are managed in multiple pipelines.
