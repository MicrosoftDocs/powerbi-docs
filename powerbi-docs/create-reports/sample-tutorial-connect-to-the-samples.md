...
1. Select the **This Year's Sales, New & Existing Stores** tile, of **$22 M**. 
    ...
    :::image type="content" source="media/sample-tutorial-connect-to-the-samples/retail-dashboard-this-years-sales.png" alt-text="Screenshot showing This Year's Sales tile selected.":::
...
1. Select **More options** (**...**) next to the **Retail Analysis Sample** dataset, then choose **Create report**.
   ...
   ![Screenshot showing a brand-new report in report-editing mode.](media/sample-tutorial-connect-to-the-samples/power-bi-report-editing.png)
