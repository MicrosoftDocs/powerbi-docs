...
If your report uses a different theme from the dashboard theme, you can control whether the visual retains current report theme or uses the dashboard theme, to achieve consistency across visuals from various sources. 
