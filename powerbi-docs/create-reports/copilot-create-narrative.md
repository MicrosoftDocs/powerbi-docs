...
We're continuously working to improve the quality of the report pages, including visuals, summaries, and synonyms generated by Copilot. Here are the current limitations. See [Considerations and limitations](copilot-introduction.md#considerations-and-limitations) in the "Overview of Copilot for Power BI" article for others.
