...
New to creating in Power BI? Read [Reports in Power BI](../explore-reports/end-user-reports.md) for some quick background information.

:::image type="content" source="media/service-quick-create-report/quick-create.gif" alt-text="Animation showing the steps to create a report on the Power BI service." lightbox="media/service-quick-create-report/quick-create.gif":::
...
:::image type="content" source="media/service-quick-create-report/create-entry-point.png" alt-text="Screenshot of the Create button on the Power BI service." lightbox="media/service-quick-create-report/create-entry-point.png":::
...
:::image type="content" source="media/service-quick-create-report/create-source-options.png" alt-text="Screenshot of the Add data to create a report options." lightbox="media/service-quick-create-report/create-source-options.png":::

:::image type="content" source="media/service-quick-create-report/create-enter-data-window.png" alt-text="Screenshot of the Power Query window for entering data." lightbox="media/service-quick-create-report/create-enter-data-window.png":::
...
:::image type="content" source="media/service-quick-create-report/change-data-type.png" alt-text="Screenshot showing the Data type options for a column." lightbox="media/service-quick-create-report/change-data-type.png":::
...
:::image type="content" source="media/service-quick-create-report/edit-entry-point.png" alt-text="Screenshot of the Edit button in the menu bar." lightbox="media/service-quick-create-report/edit-entry-point.png":::
