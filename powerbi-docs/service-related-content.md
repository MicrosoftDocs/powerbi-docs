...
![related content](media/service-related-content/power-bi-view-related-dashboard-new.png)
...
In a workspace, select the **Dashboards** tab and then select the **View related** icon ![View related icon](media/service-related-content/power-bi-view-related-icon-new.png)  .

![Dashboard tab](media/service-related-content/power-bi-view-related-dash-newer.png)

<br>

**Method 2**

With a dashboard open, select   ![View related icon](media/service-related-content/power-bi-view-related-new.png) from the top menubar.
...
![Related content pane](media/service-related-content/power-bi-view-related-dashboard-new.png)
...
In a workspace, select the **Reports** tab and then select the **View related** icon ![View related icon](media/service-related-content/power-bi-view-related-icon-new.png)  .

![Reports tab](media/service-related-content/power-bi-view-related-report-newer.png)

<br>

**Method 2**

Open the report in [Reading view](service-reading-view-and-editing-view.md) and select   ![View related icon](media/service-related-content/power-bi-view-related-new.png) from the top menubar.
...
![Related content pane](media/service-related-content/power-bi-view-related-report.png)
...
In a workspace, select the **Datasets** tab and locate the **View related** icon ![View related icon](media/service-related-content/power-bi-view-related-icon-new.png)  .

![Datasets tab](media/service-related-content/power-bi-view-related-dataset-newer.png)
...
* If your browser doesn't have enough space, you won't see an option for **View related** but you will still see the View related icon  ![View related icon](media/service-related-content/power-bi-view-related-icon-new.png)  . Select the icon to open the **Related content** pane.
