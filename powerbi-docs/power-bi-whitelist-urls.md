...
| Row | Purpose | Destination(s) | Port(s) |
| --- | --- | --- | --- |
| 1 | **Required:** Import a custom visual from the Marketplace interface or from a file | *.azureedge.net <br> *.blob.core.windows.net <br> store.office.com <br> *.osi.office.net <br> *.msecnd.net <br> web.vortex.data.microsoft.com <br> store-images.s-microsoft.com | TCP 443 |
