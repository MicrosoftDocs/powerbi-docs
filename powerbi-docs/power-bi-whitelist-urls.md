...
Power BI depends on certain endpoints to view and access custom visuals. You must be able to connect to the endpoints in the table and linked sites below.
