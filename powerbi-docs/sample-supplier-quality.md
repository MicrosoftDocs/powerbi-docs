...
This tutorial uses the Power BI service and the Supplier Quality Analysis sample content pack. Because the report experiences are so similar, you can also follow along by using Power BI Desktop and the sample .pbix file. 
