...
* Email subscriptions don't support most [Power BI custom visuals](developer/visuals/power-bi-custom-visuals.md).  The one exception is those Power BI visuals that have been [certified](developer/visuals/power-bi-custom-visuals-certified.md).  
