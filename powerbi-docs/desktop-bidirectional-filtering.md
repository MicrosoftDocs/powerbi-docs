...
When filtering tables to create the appropriate view of data, report creators and data modelers face challenges when determining how to apply filtering to a report. Previously, the filter context of a table was held on one side of the relationship, but not the other. This arrangement often required complex DAX formula to get the wanted results.
