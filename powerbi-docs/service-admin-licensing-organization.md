...
If you want to see which users in your organization may already have a license, see [View and manage user licenses](..service-admin-manage-licensese.md) to learn how.
