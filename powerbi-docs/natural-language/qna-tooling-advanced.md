...
Linguistic schemas can be edited, imported, and exported from the ribbon in Power BI Desktop. One way to edit a linguistic schema is to use the Power BI [Q&A Tooling experience](qna-tooling-intro.md). You don't have to open the YAML file in order to improve Q&A.
