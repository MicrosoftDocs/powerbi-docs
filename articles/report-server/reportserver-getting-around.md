...
![](media/reportserver-getting-around/report-server-web-portal.png)
...
1. Select the ellipsis (**...**) in the upper-right corner of the report tile > **Edit in Power BI Desktop**.
    ...
    ![](media/reportserver-getting-around/report-server-web-portal-pbix-ellipsis.png)
...
1. Select **New** > **Paginated Report**.
    ...
    ![](media/reportserver-getting-around/report-server-report-builder-new.png)
...
1. Select the ellipsis (...) in the upper-right corner of the report tile > **Edit in Report Builder**.
    ...
    ![](media/reportserver-getting-around/report-server-web-portal-rdl-ellipsis.png)
...
1. Select the ellipsis (...) in the upper-right corner of an item, then select **Manage**.
    ...
    ![](media/reportserver-getting-around/report-server-web-portal-manage-ellipsis.png)

2. Choose the property or other feature you want to set.

    ![](media/reportserver-getting-around/report-server-web-portal-manage-properties.png)
...
2. Select **Hide this item**.
    ...
    ![](media/reportserver-getting-around/report-server-web-portal-hide-property.png)
...
1. Select **Tiles** (or **List**) in the upper-right corner > **Show hidden items**.
    ...
    ![](media/reportserver-getting-around/report-server-web-portal-show-hidden-grayed.png)
...
![](media/reportserver-getting-around/report-server-web-portal-search.png)
...
1. Select **Tiles** > **List**.
    ...
    ![](media/reportserver-getting-around/report-server-web-portal-list-view.png)
