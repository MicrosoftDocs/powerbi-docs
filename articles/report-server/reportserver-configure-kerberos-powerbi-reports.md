<properties
   pageTitle="Configure Kerberos to use Power BI reports"
...
![](media/reportserver-configure-kerberos-powerbi-reports/powerbi-report-config-error.png)
...
> [AZURE.NOTE] In order to configure SPNs and delegation settings, you need to be a domain administrator.
...
> [AZURE.NOTE] You will need domain admin rights in order to create the SPN.
...
> [AZURE.NOTE] You can verify the URL by either looking at what you enter into the address bar of the browser, or you can look in the Report Server Configuration Manager on the Web Portal URL tab.
...
15. Select **Ok**. The dialog should look similar to the following if you checked **Expanded**.
    ...
    ![](media/reportserver-configure-kerberos-powerbi-reports/powerbi-report-config-delegation.png)
...
![](media/reportserver-configure-kerberos-powerbi-reports/powerbi-report.png)
