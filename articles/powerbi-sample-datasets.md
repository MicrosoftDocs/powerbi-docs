<properties
   pageTitle="Take a tour of the samples available with Power BI"
...
### Human Resources sample  ![](media/powerbi-sample-datasets/power-bi-hr.png)
...
### IT Spend Analysis sample ![](media/powerbi-sample-datasets/power-bi-it.png)
...
### Opportunity Analysis sample  ![](media/powerbi-sample-datasets/power-bi-oa.png)
...
### Procurement Analysis sample  ![](media/powerbi-sample-datasets/power-bi-pa.png)
[Take a tour of the Procurement Analysis sample](powerbi-sample-procurement-analysis-take-a-tour.md)

This industry sample analyzes a CFO's key metrics for her executives, products, and customers. You can investigate what factors impact the company's profitability

### Retail Analysis sample  ![](media/powerbi-sample-datasets/power-bi-rs.png)
...
### Sales and Marketing sample  ![](media/powerbi-sample-datasets/power-bi-sm.png)
...
### Supplier Quality sample  ![](media/powerbi-sample-datasets/power-bi-sq.png)
...
3.  On the Get Data page that appears, select the **Samples** icon.
    ...
    ![](media/powerbi-sample-datasets/power-bi-samples-icon.png)
...
3.  On the Get Data page that appears, select **Files > Get**.

      ![](media/powerbi-sample-datasets/power-bi-files.png)

4.  Navigate to the location where you downloaded and saved the sample.

    ![](media/powerbi-sample-datasets/power-bi-files3.png)

5.  Select the file, in this case **Procurement Analysis Sample.xlsx** which was saved on OneDrive for Business, and choose **Connect**.

    ![](media/powerbi-sample-datasets/power-bi-connect2.png)

6. Choose whether to import the data or to bring the workbook into Power BI and see it exactly as it is in Excel online.

    ![](media/powerbi-sample-datasets/power-bi-import.png)

5.  If you select **Import**, Power BI imports the sample workbook and adds it as a new dataset named **Procurement Analysis Sample**.  If the workbook has any Power View sheets, tables or ranges, or a data model, Power BI also creates a report (with the same name). And if you don't already have a dashboard open, Power BI creates a new dashboard. (If you had a dashboard open when you clicked **Get Data**, you'll see a new blank tile on that dashboard.  Clicking that tile will take you to the report for the dataset you just added). The new content is named after the sample and is marked with a yellow asterisk.
...
3.  From Desktop, select **File > Open** and navigate to the location where you saved the sample .pbix.

    ![](media/powerbi-sample-datasets/power-bi-desktop-open.png)
