...
-    At the current time, subscribe is not available for dashboards or reports that come from content packs. But there is a workaround...publish a [Power BI app](powerbi-service-what-are-apps.md) instead.  Email subscriptions are supported on dashboards and reports that come from Power BI apps.
...
- If you share a dashboard with a colleague outside of your tenant, they will not be able to subscribe to the dashboard or its associated report pages. So if you are aaron@contoso.com, you can share with anyone@adventureworks.com.  But anyone@adventureworks.com cannot subscribe to the shared content.    
