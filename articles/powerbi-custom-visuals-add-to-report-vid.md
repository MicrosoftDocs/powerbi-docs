...
>  [AZURE.SELECTOR]
- [Desktop](powerbi-custom-visuals-use.md)  
- [Service /(Powerbi.com/)](powerbi-custom-visuals-add-to-report.md)
...
> [AZURE.SELECTOR-LIST (Level of detail)]
- [(More detail )](powerbi-custom-add-to-report_new.md)
- [(Less detail )](powerbi-custom-add-to-report-less.md)
- [(Show me )](Connect-event-2015/321)


> [AZURE.VIDEO Connect-event-2015/321]
