...
If you want to be exhaustive, substitute the **ComputerName** and **Port** values with those listed for [ports](https://powerbi.microsoft.com/documentation/powerbi-gateway-enterprise/#ports)
