...
To help separate the end users of your application, you can create App workspaces to isolate dashboards and workspaces. This would allow you to keep dashboards and reports separated between clients you may be working with.
...
You do not need an app workspace to embed reports into your application. If you do not use an App workspace, your dashboards and reports will be in your My Workspace.

## Create and upload your reports

You will create and upload your reports to Power BI and place them either within an App workspace or in a My workspace of a Power BI user.
...
1. Purchase a capacity that fits your needs. We will have a calculator to estimate teh required capacity size.
