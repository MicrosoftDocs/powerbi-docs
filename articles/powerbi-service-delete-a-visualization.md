<properties pageTitle="Delete a visualization in Power BI" description="Delete a visualization in Power BI" services="powerbi" documentationCenter="" authors="v-anpasi" manager="mblythe" editor=""/>
...
2.  Select the visualization and click the X icon ![](media/powerbi-service-delete-a-visualization/pbi_Nancy_X_icon.png) to delete.

    ![](media/powerbi-service-delete-a-visualization/Untitled.gif)
