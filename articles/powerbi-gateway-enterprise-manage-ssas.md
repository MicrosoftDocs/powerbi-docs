...
> **Note**: You may inadvertantly change a user that you didn't intent to. The values you enter are a straight replace. For example, if your original value is *@contoso.com* and your **New name** is *@contoso.local*, all users with a sign in that contains *@contoso.com* will then be replaced with *@contoso.local*. Also, if you have an **Original name** of *dave@contoso.com* and your **New name** is *dave@contoso.local*, a user with the sign in of v-dave@contoso.local would be sent as v-dave@contoso.local.
