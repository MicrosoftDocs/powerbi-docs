...
3.  Tap a dashboard to open it.  
     ...
     ![](media/powerbi-mobile-create-dashboard/power-bi-iphone-dashboard-home.png)

     -     The yellow stars ![](media/powerbi-mobile-create-dashboard/power-bi-mobile-yes-favorite-icon.png) show which dashboards are favorites. 
    ...
    By default, Power BI dashboards look a little different on your iPhone. All the tiles appear the same size, and they're arranged one after another from top to bottom.
     ...
     ![](media/powerbi-mobile-create-dashboard/power-bi-iphone-dashboard-portrait.png)
...
4.  Swipe up and down to see all the tiles in the dashboard. You can:
    ...
    -  Tap the ellipsis to open the dashboard menu...
        ...
        ![](media/powerbi-mobile-create-dashboard/power-bi-iphone-dashboard-ellipsis-menu.png)

        Then tap to [add a picture tile](powerbi-mobile-picture-tiles-in-the-iphone-app.md) to your dashboard.

        ![](media/powerbi-mobile-create-dashboard/power-bi-iphone-dashboard-picture-tile-menu.png)
...
6.  To get back to the list of dashboards, tap the arrow next to the dashboard title, then tap **My Workspace**.
    ...
    ![](media/powerbi-mobile-create-dashboard/power-bi-iphone-breadcrumb.png)
...
2.  Tap **Dashboards** at the top of the app.  
    ...
    ![](media/powerbi-mobile-create-dashboard/power-bi-ipad-dashboard-home.png)
...
4.  To go back to My Workspace, tap the name of the dashboard in the upper-left corner, then tap **My Workspace**.
    ...
    ![](media/powerbi-mobile-create-dashboard/power-bi-dashboard-breadcrumb.png)
...
3.  Tap a dashboard to open it.   
    ...
    ![](media/powerbi-mobile-create-dashboard/power-bi-android-dashboards.png)


     -     Yellow stars ![](media/powerbi-mobile-create-dashboard/power-bi-mobile-yes-favorite-icon.png) show which dashboards are favorites. 

     -     A notation below a dashboard name ![](media/powerbi-mobile-create-dashboard/power-bi-android-dashboard-medium-classification.png) shows how the data in each dashboard is classified. Read more about [data classification in Power BI](powerbi-service-data-classification.md).
...
5.  While on the dashboard, you can tap the vertical ellipsis (...) next to the name to invite a colleague, refresh, or get information about the dashboard:
    ...
    ![](media/powerbi-mobile-create-dashboard/pbi_andr_dashellipsis.png)
...
![](media/powerbi-mobile-create-dashboard/power-bi-android-landscape-dashboard.png)
...
3.  Tap a dashboard to open it.   
    ...
    ![](media/powerbi-mobile-create-dashboard/power-bi-android-tablet-dashboard-home.png)

     -     The yellow stars ![](media/powerbi-mobile-create-dashboard/power-bi-mobile-yes-favorite-icon.png) show which dashboards are favorites. 

     -     The notation below each dashboard name ![](media/powerbi-mobile-create-dashboard/power-bi-android-dashboard-medium-classification.png) shows how the data in each dashboard is classified. Read more about [data classification in Power BI](powerbi-service-data-classification.md).
...
6.  To go back to the dashboards home page, tap the dashboard name to open the breadcrumb trail, then tap **My Workspace**:
     ...
     ![](media/powerbi-mobile-create-dashboard/power-bi-android-tablet-breadcrumb.png)
...
2.  Tap a dashboard to open it.   
    ...
    ![](media/powerbi-mobile-create-dashboard/power-bi-windows-10-device-dashboard-home.png)
