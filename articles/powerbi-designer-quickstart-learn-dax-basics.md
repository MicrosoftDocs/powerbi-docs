...
We’re going to focus on understanding DAX formulas used in calculations, more specifically, in measures and calculated columns. You should already be familiar with Power BI Designer, importing data, adding fields to a report, and you should also be familiar with fundamental concepts of [Measures](https://support.powerbi.com/knowledgebase/articles/554577-measures-in-power-bi-designer) and C[alculated columns](https://support.powerbi.com/knowledgebase/articles/590598-calculated-columns-in-power-bi-designer).
...
![](media/powerbi-designer-quickstart-learn-dax-basics/DAXQS_Syntax.png)
...
Let’s go over a few more things about this formula. In particular, we introduced a function, [SUM](https://support.office.com/en-us/article/SUM-Function-DAX-5a01483a-8426-40d8-8eb2-be04358b7d50). Functions are pre-written formulas that make it easier to do complex calculations and manipulations with numbers, dates, time, text, and more. You will learn more about functions later.
...
**9.** Click the checkmark ![](media/powerbi-designer-quickstart-learn-dax-basics/QSDAX_Syntax_TaskCheckmark.png) in the formula bar or press Enter to validate the formula and add it to the model.
...
![](media/powerbi-designer-quickstart-learn-dax-basics/QSDAX_Example.png)

You were just introduced to several important aspects of DAX formulas. First, this formula included two functions. Notice [PREVIOUSQUARTER](https://support.office.com/en-us/article/PREVIOUSQUARTER-Function-DAX-d6dd1ba0-0541-4c03-b928-f6884078e736?ui=en-US&rs=en-US&ad=US), a time intelligence, function is nested as an argument passed to [CALCULATE](https://support.office.com/en-us/article/CALCULATE-19654bc2-aa88-4f6c-a0b9-6fa7a59c4432 "CALCULATE"), a filter function. DAX formulas can contain up to 64 nested functions. It’s unlikely a formula would ever contain so many nested functions. In fact, such a formula would be very difficult to create and debug, and it probably wouldn’t be very fast either.
...
DAX includes the following categories of functions: [Date and Time](https://support.office.com/en-us/article/Date-and-Time-Functions-DAX-052a31ec-10b5-4481-b3a3-66ff9144e1c1), [Time Intelligence](https://support.office.com/en-us/article/Time-Intelligence-Functions-DAX-0571dcda-e4e8-42a8-b205-e1f0f9301b26), [Information](https://support.office.com/en-us/article/Logical-Functions-DAX-3e6f6898-8d50-4d0f-9e2c-99bb2aa1a8bc), [Logical](https://support.office.com/en-us/article/Logical-Functions-DAX-3e6f6898-8d50-4d0f-9e2c-99bb2aa1a8bc), [Mathematical](https://support.office.com/en-us/article/Math-and-Trig-Functions-DAX-c780a73e-944e-46c4-a367-b50bff1767e2), [Statistical](https://support.office.com/en-us/article/Statistical-Functions-DAX-68df5baa-b6f5-4064-befb-d5d8c6c0a7be), [Text](https://support.office.com/en-us/article/Text-Functions-DAX-4dcc8e50-c6a0-45c5-890b-b81c8af67a53), [Parent/Child](https://support.office.com/en-us/article/ParentChild-Functions-DAX-9a8604a0-6f25-49a6-b275-df26084aa6f5) and [Other](https://support.office.com/en-us/article/Other-Functions-DAX-6a9cb293-8cd2-4b25-adb5-e1c05892aeb1) functions. If you’re familiar with functions in Excel formulas, many of the functions in DAX will appear similar to you; however, DAX functions are unique in the following ways:
...
![](media/powerbi-designer-quickstart-learn-dax-basics/DAXQS_FilterContext.png)
...
3.  [Text Functions](https://support.office.com/en-us/article/Text-Functions-4dcc8e50-c6a0-45c5-890b-b81c8af67a53 "Text Functions").
