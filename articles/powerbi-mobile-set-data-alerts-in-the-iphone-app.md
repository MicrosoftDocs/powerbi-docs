...
4. [Open your **Notification center**](powerbi-mobile-notification-center.md)  to see the alert details.
...
2.  Tap the bell icon ![](media/powerbi-mobile-set-data-alerts-in-the-iphone-app/power-bi-iphone-alert-icon.png).  
