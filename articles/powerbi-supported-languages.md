...
The Power BI Preview (in your browser) is available in the following 44 languages:
...
At this time in the Preview, a few features are available in English only:
...
1.  Click the Tools button in the top-right corner of your browser window:
    ...
    ![](media/powerbi-supported-languages/InternetExplorer11.png)

2.  Click **Internet Options**.
3.  In in the Internet Options dialog, on the General tab under Appearance, click the **Languages** button.

### Google Chrome (version 42)

1.  Click the menu button in the top-right corner of your browser window:

    ![](media/powerbi-supported-languages/GoogleChrome42.png)
