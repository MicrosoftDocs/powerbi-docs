<properties
   pageTitle="Scan a Power BI QR code from your Android tablet"
...
# Scan a Power BI QR code from your Android tablet
...
You can scan the QR code for immediate access to the relevant tile, right from your Android tablet, using either the scanner in the Power BI app, or any other scanner installed on your Android tablet.
...
2. Scroll down to **QR Scanner** ![](media/powerbi-mobile-qr-code-for-android-tablet/power-bi-android-scanner-icon.png) and select it. 
...
4. Point the scanner at the Power BI QR code. 
    ...
    ![](media/powerbi-mobile-qr-code-for-android-tablet/PBI_iPh_QRScan.png)

5. The tile opens automatically in Power BI.

    ![](media/powerbi-mobile-qr-code-for-android-tablet/power-bi-android-tile.png)


## Scan a QR code from an external scanner on your Android tablet

1. From any scanner installed on your Android tablet, point the scanner to the relevant Power BI QR code for immediate access to the tile. 
...
- [Get started with the Power BI for Android app](powerbi-mobile-android-tablet-app-get-started.md)
