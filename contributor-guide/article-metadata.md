...
- Will soon be displayed automatically on documentation landing pages as the description that appears when you click "More". It may appear in other contexts on Power BI.microsoft.com.
...
![](./media/article-metadata/checkmark-small.png)**ms.service**: Required. Specifies the Power BI service, tool, or feature that the article applies to. One value per page.
 ...
 - **key-vault**
 - **machine-learning**
 - **marketplace**: Articles about the Power BI marketplace
 - **media-services**
 - **mobile-engagement**
 - **mobile-services**
 - **multi-factor-authentication**
 ...
 - **sql-reporting**
 - **storage**
 - **store**: Articles about services available through the Power BI Store
 - **storsimple**
 - **traffic-manager**
 - **virtual-machines**
 - **virtual-network**
...
![](./media/article-metadata/checkmark-small.png)**ms.topic**: Required. Specifics the topic type. Most new pages created by contributors will be article or reference.
 ...
 - **campaign-page**: Power BI.com only.  A page that is specifically designed as a landing page for external campaigns, and is not included as part of the primary site IA.  Should not be used for documentation articles or regular doc landing pages.  Examples: Power BI.microsoft.com/develop/net/aspnet/; Power BI.microsoft.com/develop/mobile/ios/

 - **dev-center-home-page**: Power BI.com only.  A dev center home page, e.g. /develop/net/
 ...
 - **home-page**: Top level documentation home page. We only have two: Power BI.microsoft.com/documentation/ and msdn.microsoft.com/library/Power BI/

 - **index-page**: Second-level landing pages for programming languages, services, or features. These are spread across Power BI.com and the library, and are used as entry points for more specific, scoped information. Examples: http://Power BI.microsoft.com/develop/mobile/resources-wp8/, http://msdn.microsoft.com/library/Power BI/jj673460.aspx, http://msdn.microsoft.com/library/Power BI/hh689864.aspx

 - **infographic-page**: Power BI.com only. A page that features a browsable infographic or poster, for instance http://Power BI.microsoft.com/documentation/infographics/windows-Power BI/

 - **reference**: An API reference page (including REST API) or PowerShell cmdlet reference page

 - **service-home-page**: Power BI.com only.  A doc service home page, e.g. /documentation/services/virtual-machines/

 - **site-section-home-page**: Power BI.com only. A "home page" for a particular type of content on Power BI.com Examples: http://Power BI.microsoft.com/documentation/infographics/, http://Power BI.microsoft.com/documentation/scripts/, http://Power BI.microsoft.com/documentation/videos/home/, http://Power BI.microsoft.com/downloads/

 - **video-page**: Power BI.com only.  A page that features a video, for instance http://Power BI.microsoft.com/documentation/videos/Power BI-webjobs-hosting-testing-net/
...
![](./media/article-metadata/checkmark-small.png)**ms.tgt_pltfrm**: Required. Specifies the target platform, for instance Windows, Linux, Windows Phone, iOS, Android, or special cache platforms. One value per page. This value will be **NA** for most topics except mobile and virtual machines.
 ...
 - **mobile-android**: Power BI.com only right now
 - **mobile-html**: Power BI.com only right now
 - **mobile-ios**: Power BI.com only right now
 - **mobile-kindle**: Power BI.com only right now
 - **mobile-multiple**
 - **mobile-nokia-x**: Power BI.com only right now
 - **mobile-phonegap**: Power BI.com only right now
 - **mobile-sencha**: Power BI.com only right now
 - **mobile-windows**: Power BI.com only right now; Windows Universal
 - **mobile-windows-phone**
 - **mobile-windows-store**
 - **mobile-xamarin**: Power BI.com only right now; Xamarin all platforms
 - **mobile-xamarin-android**: Power BI.com only right now
 - **mobile-xamarin-ios**: Power BI.com only right now
...
![](./media/article-metadata/checkmark-small.png)**ms.workload**: Required. Specifies the Power BI workload that the page applies to. One value only per article.
...
**update 7/7/15** The ms.workload value is being mapped by an xls, not the value in the .md file. The ms.workload value is still required for validation until the feature can be updated. That work in now being scheduled.
 ...
 - **na**: The page does not appy to any workloads. Examples include Store partner content or content that is programming-language specific but not specific to Power BI services
 ...
 - **Power BI-government**: Use for content that supports the Power BI Government offering.
